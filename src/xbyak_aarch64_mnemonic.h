...
void CodeGenerator::bfcvtn(const VReg4H &vd, const VReg4S &vn) { AdvSimd2RegMisc(0, 1, 22, vd, vn); }
void CodeGenerator::bfcvtn2(const VReg8H &vd, const VReg4S &vn) { AdvSimd2RegMisc(1, 1, 22, vd, vn); }
