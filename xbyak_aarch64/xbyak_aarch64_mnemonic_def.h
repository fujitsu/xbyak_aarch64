...
// SME
void addha(const ZARegS &za, const _PReg &pn, const _PReg &pm, const ZRegS &zn);
void addha(const ZARegD &za, const _PReg &pn, const _PReg &pm, const ZRegD &zn);
void addva(const ZARegS &za, const _PReg &pn, const _PReg &pm, const ZRegS &zn);
void addva(const ZARegD &za, const _PReg &pn, const _PReg &pm, const ZRegD &zn);
void addspl(const XReg &rd, const XReg &rn, const int32_t imm6);
void addsvl(const XReg &rd, const XReg &rn, const int32_t imm6);
void bfmopa(const ZARegS &za, const _PReg &pn, const _PReg &pm, const ZRegH &zn, const ZRegH &zm);
void bfmops(const ZARegS &za, const _PReg &pn, const _PReg &pm, const ZRegH &zn, const ZRegH &zm);
void fmopa(const ZARegS &za, const _PReg &pn, const _PReg &pm, const ZRegH &zn, const ZRegH &zm);
void fmopa(const ZARegS &za, const _PReg &pn, const _PReg &pm, const ZRegS &zn, const ZRegS &zm);
void fmopa(const ZARegD &za, const _PReg &pn, const _PReg &pm, const ZRegD &zn, const ZRegD &zm);
void fmops(const ZARegS &za, const _PReg &pn, const _PReg &pm, const ZRegH &zn, const ZRegH &zm);
void fmops(const ZARegS &za, const _PReg &pn, const _PReg &pm, const ZRegS &zn, const ZRegS &zm);
void fmops(const ZARegD &za, const _PReg &pn, const _PReg &pm, const ZRegD &zn, const ZRegD &zm);
void ld1b(const _ZAHVReg &za0hv, const _PReg &pg, const AdrReg &adr);
void ld1b(const _ZAHVReg &za0hv, const _PReg &pg, const AdrNoOfs &adr);
void st1b(const _ZAHVReg &za0hv, const _PReg &pg, const AdrReg &adr);
void st1b(const _ZAHVReg &za0hv, const _PReg &pg, const AdrNoOfs &adr);
void ld1h(const _ZAHVReg &zahv, const _PReg &pg, const AdrReg &adr);
void ld1h(const _ZAHVReg &zahv, const _PReg &pg, const AdrNoOfs &adr);
void st1h(const _ZAHVReg &zahv, const _PReg &pg, const AdrReg &adr);
void st1h(const _ZAHVReg &zahv, const _PReg &pg, const AdrNoOfs &adr);
void ld1w(const _ZAHVReg &zahv, const _PReg &pg, const AdrReg &adr);
void ld1w(const _ZAHVReg &zahv, const _PReg &pg, const AdrNoOfs &adr);
void st1w(const _ZAHVReg &zahv, const _PReg &pg, const AdrReg &adr);
void st1w(const _ZAHVReg &zahv, const _PReg &pg, const AdrNoOfs &adr);
void ld1d(const _ZAHVReg &zahv, const _PReg &pg, const AdrReg &adr);
void ld1d(const _ZAHVReg &zahv, const _PReg &pg, const AdrNoOfs &adr);
void st1d(const _ZAHVReg &zahv, const _PReg &pg, const AdrReg &adr);
void st1d(const _ZAHVReg &zahv, const _PReg &pg, const AdrNoOfs &adr);
void ld1q(const _ZAHVReg &zahv, const _PReg &pg, const AdrReg &adr);
void ld1q(const _ZAHVReg &zahv, const _PReg &pg, const AdrNoOfs &adr);
void st1q(const _ZAHVReg &zahv, const _PReg &pg, const AdrReg &adr);
void st1q(const _ZAHVReg &zahv, const _PReg &pg, const AdrNoOfs &adr);
void ldr(const ZAReg &za, const AdrImm &adr);
void ldr(const ZAReg &za, const AdrNoOfs &adr);
void str(const ZAReg &za, const AdrImm &adr);
void str(const ZAReg &za, const AdrNoOfs &adr);
void mov(const ZRegB &zd, const _PReg &pg, const _ZAHVReg &za0hv);
void mova(const ZRegB &zd, const _PReg &pg, const _ZAHVReg &za0hv);
void mov(const ZRegH &zd, const _PReg &pg, const _ZAHVReg &zahv);
void mova(const ZRegH &zd, const _PReg &pg, const _ZAHVReg &zahv);
void mov(const ZRegS &zd, const _PReg &pg, const _ZAHVReg &zahv);
void mova(const ZRegS &zd, const _PReg &pg, const _ZAHVReg &zahv);
void mov(const ZRegD &zd, const _PReg &pg, const _ZAHVReg &zahv);
void mova(const ZRegD &zd, const _PReg &pg, const _ZAHVReg &zahv);
void mov(const ZRegQ &zd, const _PReg &pg, const _ZAHVReg &zahv);
void mova(const ZRegQ &zd, const _PReg &pg, const _ZAHVReg &zahv);
void mov(const _ZAHVReg &za0hv, const _PReg &pg, const ZRegB &zn);
void mova(const _ZAHVReg &za0hv, const _PReg &pg, const ZRegB &zn);
void mov(const _ZAHVReg &zahv, const _PReg &pg, const ZRegH &zn);
void mova(const _ZAHVReg &zahv, const _PReg &pg, const ZRegH &zn);
void mov(const _ZAHVReg &zahv, const _PReg &pg, const ZRegS &zn);
void mova(const _ZAHVReg &zahv, const _PReg &pg, const ZRegS &zn);
void mov(const _ZAHVReg &zahv, const _PReg &pg, const ZRegD &zn);
void mova(const _ZAHVReg &zahv, const _PReg &pg, const ZRegD &zn);
void mov(const _ZAHVReg &zahv, const _PReg &pg, const ZRegQ &zn);
void mova(const _ZAHVReg &zahv, const _PReg &pg, const ZRegQ &zn);
void rdsvl(const XReg &rd, const int32_t imm6);
void smopa(const ZARegS &zaS, const _PReg &pn, const _PReg &pm, const ZRegB &zn, const ZRegB &zm);
void smopa(const ZARegD &zaD, const _PReg &pn, const _PReg &pm, const ZRegH &zn, const ZRegH &zm);
void smops(const ZARegS &zaS, const _PReg &pn, const _PReg &pm, const ZRegB &zn, const ZRegB &zm);
void smops(const ZARegD &zaD, const _PReg &pn, const _PReg &pm, const ZRegH &zn, const ZRegH &zm);
void sumopa(const ZARegS &zaS, const _PReg &pn, const _PReg &pm, const ZRegB &zn, const ZRegB &zm);
void sumopa(const ZARegD &zaD, const _PReg &pn, const _PReg &pm, const ZRegH &zn, const ZRegH &zm);
void sumops(const ZARegS &zaS, const _PReg &pn, const _PReg &pm, const ZRegB &zn, const ZRegB &zm);
void sumops(const ZARegD &zaD, const _PReg &pn, const _PReg &pm, const ZRegH &zn, const ZRegH &zm);
void umopa(const ZARegS &zaS, const _PReg &pn, const _PReg &pm, const ZRegB &zn, const ZRegB &zm);
void umopa(const ZARegD &zaD, const _PReg &pn, const _PReg &pm, const ZRegH &zn, const ZRegH &zm);
void umops(const ZARegS &zaS, const _PReg &pn, const _PReg &pm, const ZRegB &zn, const ZRegB &zm);
void umops(const ZARegD &zaD, const _PReg &pn, const _PReg &pm, const ZRegH &zn, const ZRegH &zm);
void usmopa(const ZARegS &zaS, const _PReg &pn, const _PReg &pm, const ZRegB &zn, const ZRegB &zm);
void usmopa(const ZARegD &zaD, const _PReg &pn, const _PReg &pm, const ZRegH &zn, const ZRegH &zm);
void usmops(const ZARegS &zaS, const _PReg &pn, const _PReg &pm, const ZRegB &zn, const ZRegB &zm);
void usmops(const ZARegD &zaD, const _PReg &pn, const _PReg &pm, const ZRegH &zn, const ZRegH &zm);
void zero(std::initializer_list<ZARegD> list);
void zero(const ZAReg &za);
void smstart(SMod m);
void smstart();
void smstop(SMod m);
void smstop();