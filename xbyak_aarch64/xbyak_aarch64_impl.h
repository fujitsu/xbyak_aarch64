...
XBYAK_AARCH64_INLINE void CodeGenerator::PCrelAddr(uint32_t op, const XReg &rd,
                                                const Label &label) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::AddSubImm(uint32_t op, uint32_t S,
                                                const RReg &rd, const RReg &rn,
...
// Logical (immediate)
XBYAK_AARCH64_INLINE void CodeGenerator::LogicalImm(uint32_t opc, const RReg &rd,
                                                 const RReg &rn, uint64_t imm,
                                                 bool alias) {
  uint32_t sf = genSf(rd);
...
// Move wide(immediate)
XBYAK_AARCH64_INLINE void CodeGenerator::MvWideImm(uint32_t opc, const RReg &rd,
                                                uint32_t imm, uint32_t sh) {
  uint32_t sf = genSf(rd);
...
// Bitfield
XBYAK_AARCH64_INLINE void CodeGenerator::Bitfield(uint32_t opc, const RReg &rd,
                                               const RReg &rn, uint32_t immr,
                                               uint32_t imms, bool rn_chk) {
  uint32_t sf = genSf(rd);
  uint32_t N = sf;
...
// Extract
XBYAK_AARCH64_INLINE void CodeGenerator::Extract(uint32_t op21, uint32_t o0,
                                              const RReg &rd, const RReg &rn,
...
XBYAK_AARCH64_INLINE uint32_t CodeGenerator::CondBrImmEnc(uint32_t cond,
                                                       int64_t labelOffset) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::ExceptionGen(uint32_t opc, uint32_t op2,
                                                   uint32_t LL, uint32_t imm) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::Hints(uint32_t imm) {
  Hints(field(imm, 6, 3), field(imm, 2, 0));
}

// Barriers (option)
XBYAK_AARCH64_INLINE void CodeGenerator::BarriersOpt(uint32_t op2, BarOpt opt,
                                                  uint32_t rt) {
  if (op2 == 6)
...
// Barriers (no option)
XBYAK_AARCH64_INLINE void CodeGenerator::BarriersNoOpt(uint32_t CRm, uint32_t op2,
                                                    uint32_t rt) {
...
// pstate
XBYAK_AARCH64_INLINE void CodeGenerator::PState(PStateField psfield,
                                             uint32_t imm) {
  ...
  uint32_t code = concat(
      {F(0xd5, 24), F(op1, 16), F(0x4, 12), F(CRm, 8), F(op2, 5), F(0x1f, 0)});
  dd(code);
}

XBYAK_AARCH64_INLINE void CodeGenerator::PState(uint32_t op1, uint32_t CRm,
                                             uint32_t op2) {
  uint32_t code = concat(
      {F(0xd5, 24), F(op1, 16), F(0x4, 12), F(CRm, 8), F(op2, 5), F(0x1f, 0)});
  dd(code);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SysInst(uint32_t L, uint32_t op1,
                                              uint32_t CRn, uint32_t CRm,
                                              uint32_t op2, const XReg &rt) {
  uint32_t code = concat({F(0xd5, 24), F(L, 21), F(1, 19), F(op1, 16),
                          F(CRn, 12), F(CRm, 8), F(op2, 5), F(rt.getIdx(), 0)});
  dd(code);
}

// System register move
XBYAK_AARCH64_INLINE void CodeGenerator::SysRegMove(uint32_t L, uint32_t op0,
...
XBYAK_AARCH64_INLINE void CodeGenerator::UncondBrNoReg(uint32_t opc, uint32_t op2,
                                                    uint32_t op3, uint32_t rn,
                                                    uint32_t op4) {
  uint32_t code = concat(
...
XBYAK_AARCH64_INLINE void CodeGenerator::UncondBr1Reg(uint32_t opc, uint32_t op2,
                                                   uint32_t op3, const RReg &rn,
                                                   uint32_t op4) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::UncondBr2Reg(uint32_t opc, uint32_t op2,
                                                   uint32_t op3, const RReg &rn,
                                                   const RReg &rm) {
  uint32_t code = concat({F(0x6b, 25), F(opc, 21), F(op2, 16), F(op3, 10),
...
XBYAK_AARCH64_INLINE uint32_t CodeGenerator::UncondBrImmEnc(uint32_t op,
                                                         int64_t labelOffset) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::UncondBrImm(uint32_t op,
                                                  const Label &label) {
...
XBYAK_AARCH64_INLINE uint32_t CodeGenerator::CompareBrEnc(uint32_t op,
                                                       const RReg &rt,
                                                       int64_t labelOffset) {
  verifyIncRange(labelOffset, -1 * (1 << 20), ones(20), ERR_LABEL_IS_TOO_FAR,
                 true);
...
XBYAK_AARCH64_INLINE void CodeGenerator::CompareBr(uint32_t op, const RReg &rt,
                                                const Label &label) {
  auto encFunc = [&, op](int64_t labelOffset) {
...
XBYAK_AARCH64_INLINE uint32_t CodeGenerator::TestBrEnc(uint32_t op, const RReg &rt,
                                                    uint32_t imm,
                                                    int64_t labelOffset) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::TestBr(uint32_t op, const RReg &rt,
                                             uint32_t imm, const Label &label) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::TestBr(uint32_t op, const RReg &rt,
                                             uint32_t imm, int64_t label) {
  uint32_t code = TestBrEnc(op, rt, imm, label);
  dd(code);
}

// Advanced SIMD load/store multipule structure
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdLdStMultiStructExceptLd1St1(
    uint32_t L, uint32_t opc, const VRegList &vt, const AdrNoOfs &adr) {
  uint32_t Q = genQ(vt);
...
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdLdStMultiStructForLd1St1(
    uint32_t L, uint32_t opc, const VRegList &vt, const AdrNoOfs &adr) {
  AdvSimdLdStMultiStructExceptLd1St1(L, opc, vt, adr);
}

// Advanced SIMD load/store multple structures (post-indexed register offset)
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdLdStMultiStructPostRegExceptLd1St1(
    uint32_t L, uint32_t opc, const VRegList &vt, const AdrPostReg &adr) {
  uint32_t Q = genQ(vt);
  uint32_t size = genSize(vt);
  ...
  opc = (opc == 0x2 && len == 1)
            ...
            : (opc == 0x2 && len == 2) ? 0xa
                                       : (opc == 0x2 && len == 3) ? 0x6 : opc;
  uint32_t code = concat({F(Q, 30), F(0x19, 23), F(L, 22),
                          F(adr.getXm().getIdx(), 16), F(opc, 12), F(size, 10),
                          F(adr.getXn().getIdx(), 5), F(vt.getIdx(), 0)});
  dd(code);
}

XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdLdStMultiStructPostRegForLd1St1(
    uint32_t L, uint32_t opc, const VRegList &vt, const AdrPostReg &adr) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdLdStMultiStructPostImmExceptLd1St1(
    uint32_t L, uint32_t opc, const VRegList &vt, const AdrPostImm &adr) {
  uint32_t Q = genQ(vt);
  uint32_t size = genSize(vt);
  uint32_t len = vt.getLen();
...
// Advanced SIMD load/store multple structures (post-indexed immediate offset)
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdLdStMultiStructPostImmForLd1St1(
    uint32_t L, uint32_t opc, const VRegList &vt, const AdrPostImm &adr) {
  AdvSimdLdStMultiStructPostImmExceptLd1St1(L, opc, vt, adr);
}

// Advanced SIMD load/store single structures
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdLdStSingleStruct(uint32_t L, uint32_t R, uint32_t num,
                                       const VRegElem &vt,
                                       const AdrNoOfs &adr) {
  uint32_t Q = genQ(vt);
  uint32_t S = genS(vt);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdLdRepSingleStruct(uint32_t L, uint32_t R, uint32_t opcode,
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdLdStSingleStructPostReg(uint32_t L, uint32_t R,
                                              uint32_t num, const VRegElem &vt,
...
// Advanced SIMD load/store single structures (post-indexed register,
// replicate)
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdLdStSingleStructRepPostReg(
    uint32_t L, uint32_t R, uint32_t opcode, uint32_t S, const VRegVec &vt,
    const AdrPostReg &adr) {
  uint32_t Q = genQ(vt);
  uint32_t size = genSize(vt);
  uint32_t code =
      concat({F(Q, 30), F(0x1b, 23), F(L, 22), F(R, 21),
              F(adr.getXm().getIdx(), 16), F(opcode, 13), F(S, 12), F(size, 10),
              F(adr.getXn().getIdx(), 5), F(vt.getIdx(), 0)});
  dd(code);
}
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdLdStSingleStructPostImm(uint32_t L, uint32_t R,
                                              uint32_t num, const VRegElem &vt,
...
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdLdRepSingleStructPostImm(
    uint32_t L, uint32_t R, uint32_t opcode, uint32_t S, const VRegVec &vt,
    const AdrPostImm &adr) {
  uint32_t Q = genQ(vt);
  uint32_t size = genSize(vt);
...
// store exclusive
XBYAK_AARCH64_INLINE void CodeGenerator::StExclusive(uint32_t size, uint32_t o0,
                                                  const WReg ws, const RReg &rt,
                                                  const AdrImm &adr) {
  uint32_t L = 0;
  uint32_t o2 = 0;
  uint32_t o1 = 0;
  ...
  uint32_t code = concat({F(size, 30), F(0x8, 24), F(o2, 23), F(L, 22),
                          F(o1, 21), F(ws.getIdx(), 16), F(o0, 15), F(0x1f, 10),
                          F(adr.getXn().getIdx(), 5), F(rt.getIdx(), 0)});
  dd(code);
}

// load exclusive
XBYAK_AARCH64_INLINE void CodeGenerator::LdExclusive(uint32_t size, uint32_t o0,
                                                  const RReg &rt,
                                                  const AdrImm &adr) {
  uint32_t L = 1;
  uint32_t o2 = 0;
...
// store LORelease
XBYAK_AARCH64_INLINE void CodeGenerator::StLORelase(uint32_t size, uint32_t o0,
                                                 const RReg &rt,
                                                 const AdrImm &adr) {
  uint32_t L = 0;
  uint32_t o2 = 1;
...
// load LOAcquire
XBYAK_AARCH64_INLINE void CodeGenerator::LdLOAcquire(uint32_t size, uint32_t o0,
                                                  const RReg &rt,
                                                  const AdrImm &adr) {
  uint32_t L = 1;
  uint32_t o2 = 1;
...
// compare and swap
XBYAK_AARCH64_INLINE void CodeGenerator::Cas(uint32_t size, uint32_t o2,
                                          uint32_t L, uint32_t o1, uint32_t o0,
                                          const RReg &rs, const RReg &rt,
                                          const AdrNoOfs &adr) {
  verifyIncRange(rt.getIdx(), 0, SP_IDX - 1, ERR_ILLEGAL_REG_IDX);
  verifyIncRange(rs.getIdx(), 0, SP_IDX - 1, ERR_ILLEGAL_REG_IDX);

  uint32_t code = concat({F(size, 30), F(0x8, 24), F(o2, 23), F(L, 22),
                          F(o1, 21), F(rs.getIdx(), 16), F(o0, 15), F(0x1f, 10),
                          F(adr.getXn().getIdx(), 5), F(rt.getIdx(), 0)});
  dd(code);
}
...
XBYAK_AARCH64_INLINE void
CodeGenerator::StExclusivePair(uint32_t L, uint32_t o1, uint32_t o0,
                               const WReg &ws, const RReg &rt1, const RReg &rt2,
                               const AdrImm &adr) {
...
// load/store exclusive pair
XBYAK_AARCH64_INLINE void CodeGenerator::LdExclusivePair(uint32_t L, uint32_t o1,
                                                      uint32_t o0,
                                                      const RReg &rt1,
                                                      const RReg &rt2,
                                                      const AdrImm &adr) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::CasPair(uint32_t L, uint32_t o1,
                                              uint32_t o0, const RReg &rs,
                                              const RReg &rt,
                                              const AdrNoOfs &adr) {
  ...
  uint32_t code = concat({F(0, 31), F(sz, 30), F(0x8, 24), F(0, 23), F(L, 22),
                          F(o1, 21), F(rs.getIdx(), 16), F(o0, 15), F(0x1f, 10),
                          F(adr.getXn().getIdx(), 5), F(rt.getIdx(), 0)});
  dd(code);
}
...
XBYAK_AARCH64_INLINE void CodeGenerator::LdaprStlr(uint32_t size, uint32_t opc,
                                                const RReg &rt,
                                                const AdrImm &adr) {
...
XBYAK_AARCH64_INLINE uint32_t CodeGenerator::LdRegLiteralEnc(uint32_t opc,
                                                          uint32_t V,
                                                          const RReg &rt,
                                                          int64_t labelOffset) {
  verifyIncRange(labelOffset, (-1) * (1 << 20), ones(20), ERR_LABEL_IS_TOO_FAR,
...
XBYAK_AARCH64_INLINE void CodeGenerator::LdRegLiteral(uint32_t opc, uint32_t V,
                                                   const RReg &rt,
                                                   const Label &label) {
...
XBYAK_AARCH64_INLINE uint32_t
CodeGenerator::LdRegSimdFpLiteralEnc(const VRegSc &vt, int64_t labelOffset) {
  verifyIncRange(labelOffset, -1 * (1 << 20), ones(20), ERR_LABEL_IS_TOO_FAR,
                 true);
...
XBYAK_AARCH64_INLINE void CodeGenerator::LdRegSimdFpLiteral(const VRegSc &vt,
                                                         const Label &label) {
...
// prefetch (literal)
XBYAK_AARCH64_INLINE uint32_t CodeGenerator::PfLiteralEnc(Prfop prfop,
                                                       int64_t labelOffset) {
  verifyIncRange(labelOffset, -1 * (1 << 20), ones(20), ERR_LABEL_IS_TOO_FAR,
                 true);
...
XBYAK_AARCH64_INLINE void CodeGenerator::PfLiteral(Prfop prfop,
                                                const Label &label) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::LdStNoAllocPair(uint32_t L,
                                                      const RReg &rt1,
                                                      const RReg &rt2,
                                                      const AdrImm &adr) {
...
// Load/store no-allocate pair (offset)
XBYAK_AARCH64_INLINE void CodeGenerator::LdStSimdFpNoAllocPair(uint32_t L,
                                                            const VRegSc &vt1,
                                                            const VRegSc &vt2,
                                                            const AdrImm &adr) {
  int32_t imm = adr.getImm();
...
XBYAK_AARCH64_INLINE void
CodeGenerator::LdStRegPairPostImm(uint32_t opc, uint32_t L, const RReg &rt1,
  ...
  uint32_t code = concat({F(opc, 30), F(0x5, 27), F(V, 26), F(1, 23), F(L, 22),
                          F(imm7, 15), F(rt2.getIdx(), 10),
                          F(adr.getXn().getIdx(), 5), F(rt1.getIdx(), 0)});
  dd(code);
}
...
// Load/store pair (post-indexed)
XBYAK_AARCH64_INLINE void
CodeGenerator::LdStSimdFpPairPostImm(uint32_t L, const VRegSc &vt1,
                                     const VRegSc &vt2, const AdrPostImm &adr) {
  int32_t imm = adr.getImm();
  int32_t times = vt1.getBit() / 32;
...
XBYAK_AARCH64_INLINE void CodeGenerator::LdStRegPair(uint32_t opc, uint32_t L,
                                                  const RReg &rt1,
                                                  const RReg &rt2,
                                                  const AdrImm &adr) {
  int32_t imm = adr.getImm();
  ...
  uint32_t code = concat({F(opc, 30), F(0x5, 27), F(V, 26), F(2, 23), F(L, 22),
                          F(imm7, 15), F(rt2.getIdx(), 10),
                          F(adr.getXn().getIdx(), 5), F(rt1.getIdx(), 0)});
  dd(code);
}
...
// Load/store pair (offset)
XBYAK_AARCH64_INLINE void CodeGenerator::LdStSimdFpPair(uint32_t L,
                                                     const VRegSc &vt1,
                                                     const VRegSc &vt2,
                                                     const AdrImm &adr) {
  int32_t imm = adr.getImm();
...
XBYAK_AARCH64_INLINE void CodeGenerator::LdStRegPairPre(uint32_t opc, uint32_t L,
                                                     const RReg &rt1,
                                                     const RReg &rt2,
                                                     const AdrPreImm &adr) {
  int32_t imm = adr.getImm();
  ...
  uint32_t code = concat({F(opc, 30), F(0x5, 27), F(V, 26), F(3, 23), F(L, 22),
                          F(imm7, 15), F(rt2.getIdx(), 10),
                          F(adr.getXn().getIdx(), 5), F(rt1.getIdx(), 0)});
  dd(code);
}
...
// Load/store pair (pre-indexed)
XBYAK_AARCH64_INLINE void CodeGenerator::LdStSimdFpPairPre(uint32_t L,
                                                        const VRegSc &vt1,
                                                        const VRegSc &vt2,
                                                        const AdrPreImm &adr) {
  int32_t imm = adr.getImm();
...
XBYAK_AARCH64_INLINE void CodeGenerator::LdStRegUnsImm(uint32_t size, uint32_t opc,
                                                    const RReg &rt,
                                                    const AdrImm &adr) {
  int imm = adr.getImm();
...
XBYAK_AARCH64_INLINE void CodeGenerator::LdStSimdFpRegUnsImm(uint32_t opc,
                                                          const VRegSc &vt,
                                                          const AdrImm &adr) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::PfRegUnsImm(Prfop prfop,
                                                  const AdrImm &adr) {
  uint32_t size = 3;
  uint32_t opc = 2;
...
XBYAK_AARCH64_INLINE void CodeGenerator::LdStRegPostImm(uint32_t size,
                                                     uint32_t opc,
                                                     const RReg &rt,
                                                     const AdrPostImm &adr) {
  int imm = adr.getImm();
...
XBYAK_AARCH64_INLINE void
CodeGenerator::LdStSimdFpRegPostImm(uint32_t opc, const VRegSc &vt,
                                    const AdrPostImm &adr) {
  uint32_t size = (vt.getBit() == 16)
                      ? 1
                      : (vt.getBit() == 32) ? 2 : (vt.getBit() == 64) ? 3 : 0;
...
XBYAK_AARCH64_INLINE void CodeGenerator::LdStRegUnpriv(uint32_t size, uint32_t opc,
                                                    const RReg &rt,
                                                    const AdrImm &adr) {
  int imm = adr.getImm();
  uint32_t imm9 = imm & ones(9);
...
XBYAK_AARCH64_INLINE void CodeGenerator::LdStRegPre(uint32_t size, uint32_t opc,
                                                 const RReg &rt,
                                                 const AdrPreImm &adr) {
  int imm = adr.getImm();
  uint32_t imm9 = imm & ones(9);
...
XBYAK_AARCH64_INLINE void CodeGenerator::LdStSimdFpRegPre(uint32_t opc,
                                                       const VRegSc &vt,
                                                       const AdrPreImm &adr) {
  uint32_t size = (vt.getBit() == 16)
                      ? 1
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AtomicMemOp(uint32_t size, uint32_t V, uint32_t A, uint32_t R,
                           uint32_t o3, uint32_t opc, const RReg &rs,
                           const RReg &rt, const AdrNoOfs &adr) {
  uint32_t code = concat({F(size, 30), F(0x7, 27), F(V, 26), F(A, 23), F(R, 22),
                          F(1, 21), F(rs.getIdx(), 16), F(o3, 15), F(opc, 12),
                          F(adr.getXn().getIdx(), 5), F(rt.getIdx(), 0)});
  dd(code);
}
...
CodeGenerator::AtomicMemOp(uint32_t size, uint32_t V, uint32_t A, uint32_t R,
                           uint32_t o3, uint32_t opc, const RReg &rs,
                           const RReg &rt, const AdrImm &adr) {
  verifyIncList(adr.getImm(), {0}, ERR_ILLEGAL_IMM_VALUE);
  uint32_t code = concat({F(size, 30), F(0x7, 27), F(V, 26), F(A, 23), F(R, 22),
                          F(1, 21), F(rs.getIdx(), 16), F(o3, 15), F(opc, 12),
                          F(adr.getXn().getIdx(), 5), F(rt.getIdx(), 0)});
...
XBYAK_AARCH64_INLINE void CodeGenerator::LdStReg(uint32_t size, uint32_t opc,
                                              const RReg &rt,
                                              const AdrReg &adr) {
  uint32_t option = 3;
  uint32_t S =
...
// load/store register (register offset)
XBYAK_AARCH64_INLINE void CodeGenerator::LdStSimdFpReg(uint32_t opc,
                                                    const VRegSc &vt,
                                                    const AdrReg &adr) {
  uint32_t size = genSize(vt);
  uint32_t option = 3;
...
XBYAK_AARCH64_INLINE void CodeGenerator::LdStRegPac(uint32_t M, uint32_t W,
                                                 const XReg &xt,
                                                 const AdrImm &adr) {
  uint32_t size = 3;
  uint32_t V = 0;
  ...
  uint32_t code = concat({F(size, 30), F(0x7, 27), F(V, 26), F(M, 23), F(S, 22),
                          F(1, 21), F(imm9, 12), F(W, 11), F(1, 10),
...
XBYAK_AARCH64_INLINE void CodeGenerator::LdStRegUnImm(uint32_t size, uint32_t opc,
                                                   const RReg &rt,
                                                   const AdrUimm &adr) {
  int32_t imm = adr.getImm();
...
// loat/store register (unsigned immediate)
XBYAK_AARCH64_INLINE void CodeGenerator::LdStSimdFpUnImm(uint32_t opc,
                                                      const VRegSc &vt,
                                                      const AdrUimm &adr) {
  int32_t imm = adr.getImm();
...
// loat/store register (unsigned immediate)
XBYAK_AARCH64_INLINE void CodeGenerator::PfRegImm(Prfop prfop,
                                               const AdrUimm &adr) {
  int32_t imm = adr.getImm();
  int32_t times = 8;
...
XBYAK_AARCH64_INLINE void CodeGenerator::DataProc2Src(uint32_t opcode,
                                                   const RReg &rd,
                                                   const RReg &rn,
                                                   const RReg &rm) {
  ...
  uint32_t code = concat({F(sf, 31), F(S, 29), F(0xd6, 21), F(rm.getIdx(), 16),
                          F(opcode, 10), F(rn.getIdx(), 5), F(rd.getIdx(), 0)});
  dd(code);
}

// Data processing (1 source)
XBYAK_AARCH64_INLINE void CodeGenerator::DataProc1Src(uint32_t opcode2,
                                                   uint32_t opcode,
                                                   const RReg &rd,
                                                   const RReg &rn) {
  uint32_t sf = genSf(rd);
...
// Data processing (1 source)
XBYAK_AARCH64_INLINE void
CodeGenerator::DataProc1Src(uint32_t opcode2, uint32_t opcode, const RReg &rd) {
  uint32_t sf = genSf(rd);
  uint32_t S = 0;
...
XBYAK_AARCH64_INLINE void
CodeGenerator::LogicalShiftReg(uint32_t opc, uint32_t N, const RReg &rd,
                               const RReg &rn, const RReg &rm, ShMod shmod,
                               uint32_t sh) {
  uint32_t sf = genSf(rd);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AddSubShiftReg(uint32_t opc, uint32_t S, const RReg &rd,
                              const RReg &rn, const RReg &rm, ShMod shmod,
                              uint32_t sh, bool alias) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::AddSubExtReg(uint32_t opc, uint32_t S,
                                                   const RReg &rd,
                                                   const RReg &rn,
                                                   const RReg &rm,
                                                   ExtMod extmod, uint32_t sh) {
  uint32_t sf = genSf(rd);
  uint32_t opt = 0;
  ...
  uint32_t code =
      concat({F(sf, 31), F(opc, 30), F(S, 29), F(0xb, 24), F(opt, 22), F(1, 21),
              F(rm.getIdx(), 16), F(option, 13), F(imm3, 10), F(rn.getIdx(), 5),
              F(rd.getIdx(), 0)});
  dd(code);
}

// Add/subtract (with carry)
XBYAK_AARCH64_INLINE void CodeGenerator::AddSubCarry(uint32_t op, uint32_t S,
                                                  const RReg &rd,
                                                  const RReg &rn,
                                                  const RReg &rm) {
  uint32_t sf = genSf(rd);
...
XBYAK_AARCH64_INLINE void CodeGenerator::RotateR(uint32_t op, uint32_t S,
                                              uint32_t o2, const XReg &xn,
...
// Evaluate into flags
XBYAK_AARCH64_INLINE void CodeGenerator::Evaluate(uint32_t op, uint32_t S,
                                               uint32_t opcode2, uint32_t sz,
                                               uint32_t o3, uint32_t mask,
                                               const WReg &wn) {
  uint32_t sf = 0;
  ...
  uint32_t code =
      concat({F(sf, 31), F(op, 30), F(S, 29), F(0xd, 25), F(opcode2, 15),
              F(sz, 14), F(0x2, 10), F(wn.getIdx(), 5), F(o3, 4), F(mask, 0)});
  dd(code);
}

// Conditional compare (register)
XBYAK_AARCH64_INLINE void CodeGenerator::CondCompReg(uint32_t op, uint32_t S,
                                                  uint32_t o2, uint32_t o3,
                                                  const RReg &rn,
                                                  const RReg &rm, uint32_t nczv,
                                                  Cond cond) {
  ...
  uint32_t code =
      concat({F(sf, 31), F(op, 30), F(S, 29), F(0xd2, 21), F(rm.getIdx(), 16),
              F(cond, 12), F(o2, 10), F(rn.getIdx(), 5), F(o3, 4), F(nczv, 0)});
  dd(code);
}

// Conditional compare (imm)
XBYAK_AARCH64_INLINE void CodeGenerator::CondCompImm(uint32_t op, uint32_t S,
                                                  uint32_t o2, uint32_t o3,
                                                  const RReg &rn, uint32_t imm,
                                                  uint32_t nczv, Cond cond) {
  uint32_t sf = genSf(rn);
...
// Conditional select
XBYAK_AARCH64_INLINE void CodeGenerator::CondSel(uint32_t op, uint32_t S,
                                              uint32_t op2, const RReg &rd,
...
// Conditional select
XBYAK_AARCH64_INLINE void CodeGenerator::DataProc3Reg(uint32_t op54, uint32_t op31,
                                                   uint32_t o0, const RReg &rd,
                                                   const RReg &rn,
                                                   const RReg &rm,
                                                   const RReg &ra) {
  uint32_t sf = genSf(rd);
...
// Cryptographic AES
XBYAK_AARCH64_INLINE void
CodeGenerator::CryptAES(uint32_t opcode, const VRegVec &vd, const VRegVec &vn) {
  uint32_t size = genSize(vd);
  uint32_t code = concat({F(0x4e, 24), F(size, 22), F(0x14, 17), F(opcode, 12),
                          F(2, 10), F(vn.getIdx(), 5), F(vd.getIdx(), 0)});
  dd(code);
}

// Cryptographic three-register SHA
XBYAK_AARCH64_INLINE void CodeGenerator::Crypt3RegSHA(uint32_t opcode,
                                                   const VRegSc &vd,
                                                   const VRegSc &vn,
                                                   const VRegVec &vm) {
  uint32_t size = 0;
  uint32_t code = concat({F(0x5e, 24), F(size, 22), F(vm.getIdx(), 16),
                          F(opcode, 12), F(vn.getIdx(), 5), F(vd.getIdx(), 0)});
  dd(code);
}
...
XBYAK_AARCH64_INLINE void
CodeGenerator::Crypt2RegSHA(uint32_t opcode, const Reg &vd, const Reg &vn) {
  uint32_t size = 0;
  uint32_t code = concat({F(0x5e, 24), F(size, 22), F(0x14, 17), F(opcode, 12),
                          F(2, 10), F(vn.getIdx(), 5), F(vd.getIdx(), 0)});
  dd(code);
}

// Advanced SIMD Scalar copy
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdScCopy(uint32_t op, uint32_t imm4,
                                                    const VRegSc &vd,
                                                    const VRegElem &vn) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdSc3SameFp16(uint32_t U, uint32_t a,
                                                         uint32_t opcode,
                                                         const VRegSc &vd,
                                                         const VRegSc &vn,
                                                         const VRegSc &vm) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdSc2RegMiscFp16(uint32_t U, uint32_t a, uint32_t opcode,
...
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdSc3SameExtra(uint32_t U,
                                                          uint32_t opcode,
                                                          const VRegSc &vd,
                                                          const VRegSc &vn,
                                                          const VRegSc &vm) {
  ...
  uint32_t code = concat({F(1, 30), F(U, 29), F(0xf, 25), F(size, 22),
                          F(vm.getIdx(), 16), F(1, 15), F(opcode, 11), F(1, 10),
                          F(vn.getIdx(), 5), F(vd.getIdx(), 0)});
  dd(code);
}

// Advanced SIMD Scalar two-register miscellaneous
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdSc2RegMisc(uint32_t U,
                                                        uint32_t opcode,
                                                        const VRegSc &vd,
                                                        const VRegSc &vn) {
  uint32_t size = genSize(vd);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdSc2RegMisc(uint32_t U, uint32_t opcode, const VRegSc &vd,
...
// Advanced SIMD Scalar two-register miscellaneous
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdSc2RegMiscSz0x(uint32_t U,
                                                            uint32_t opcode,
                                                            const VRegSc &vd,
                                                            const VRegSc &vn) {
...
// Advanced SIMD Scalar two-register miscellaneous
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdSc2RegMiscSz1x(uint32_t U,
                                                            uint32_t opcode,
                                                            const VRegSc &vd,
                                                            const VRegSc &vn) {
  uint32_t size = genSize(vd);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdScPairwise(uint32_t U, uint32_t size, uint32_t opcode,
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdSc3Diff(uint32_t U, uint32_t opcode, const VRegSc &vd,
                              const VRegSc &vn, const VRegSc &vm) {
  uint32_t size = genSize(vn);
  uint32_t code = concat({F(1, 30), F(U, 29), F(0xf, 25), F(size, 22), F(1, 21),
                          F(vm.getIdx(), 16), F(opcode, 12), F(vn.getIdx(), 5),
                          F(vd.getIdx(), 0)});
  dd(code);
}
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdSc3Same(uint32_t U, uint32_t opcode, const VRegSc &vd,
                              const VRegSc &vn, const VRegSc &vm) {
  uint32_t size = genSize(vd);
  uint32_t code = concat({F(1, 30), F(U, 29), F(0xf, 25), F(size, 22), F(1, 21),
                          F(vm.getIdx(), 16), F(opcode, 11), F(1, 10),
...
// Advanced SIMD scalar three same
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdSc3SameSz0x(uint32_t U, uint32_t opcode, const VRegSc &vd,
                                  const VRegSc &vn, const VRegSc &vm) {
...
// Advanced SIMD scalar three same
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdSc3SameSz1x(uint32_t U, uint32_t opcode, const VRegSc &vd,
                                  const VRegSc &vn, const VRegSc &vm) {
  uint32_t size = genSize(vd);
  uint32_t code = concat({F(1, 30), F(U, 29), F(0xf, 25), F(size, 22), F(1, 21),
                          F(vm.getIdx(), 16), F(opcode, 11), F(1, 10),
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdScShImm(uint32_t U, uint32_t opcode, const VRegSc &vd,
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdScXIndElemSz(uint32_t U, uint32_t size, uint32_t opcode,
                                   const VRegSc &vd, const VRegSc &vn,
                                   const VRegElem &vm) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdScXIndElem(uint32_t U, uint32_t opcode, const VRegSc &vd,
...
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdTblLkup(uint32_t op2, uint32_t len,
                                                     uint32_t op,
                                                     const VRegVec &vd,
                                                     const VRegVec &vn,
                                                     const VRegVec &vm) {
  ...
  uint32_t code =
      concat({F(Q, 30), F(0xe, 24), F(op2, 22), F(vm.getIdx(), 16),
              F(len - 1, 13), F(op, 12), F(vn.getIdx(), 5), F(vd.getIdx(), 0)});
  dd(code);
}

// Advanced SIMD table lookup
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdTblLkup(uint32_t op2, uint32_t op,
                                                     const VRegVec &vd,
                                                     const VRegList &vn,
                                                     const VRegVec &vm) {
  uint32_t Q = genQ(vd);
  ...
  uint32_t code =
      concat({F(Q, 30), F(0xe, 24), F(op2, 22), F(vm.getIdx(), 16), F(len, 13),
              F(op, 12), F(vn.getIdx(), 5), F(vd.getIdx(), 0)});
  dd(code);
}

// Advanced SIMD permute
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdPermute(uint32_t opcode,
                                                     const VRegVec &vd,
                                                     const VRegVec &vn,
                                                     const VRegVec &vm) {
  uint32_t Q = genQ(vd);
...
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdExtract(uint32_t op2,
                                                     const VRegVec &vd,
                                                     const VRegVec &vn,
                                                     const VRegVec &vm,
                                                     uint32_t index) {
  ...
  uint32_t code = concat({F(Q, 30), F(0x2e, 24), F(op2, 22), F(vm.getIdx(), 16),
                          F(imm4, 11), F(vn.getIdx(), 5), F(vd.getIdx(), 0)});
  dd(code);
}

// Advanced SIMD copy
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdCopyDupElem(uint32_t op,
                                                         uint32_t imm4,
                                                         const VRegVec &vd,
                                                         const VRegElem &vn) {
  uint32_t Q = genQ(vd);
...
// Advanced SIMD copy
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdCopyDupGen(uint32_t op,
                                                        uint32_t imm4,
                                                        const VRegVec &vd,
                                                        const RReg &rn) {
  uint32_t Q = genQ(vd);
...
// Advanced SIMD copy
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdCopyMov(uint32_t op, uint32_t imm4,
                                                     const RReg &rd,
                                                     const VRegElem &vn) {
  uint32_t Q = genSf(rd);
  uint32_t size = genSize(vn);
...
// Advanced SIMD copy
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdCopyInsGen(uint32_t op,
                                                        uint32_t imm4,
                                                        const VRegElem &vd,
                                                        const RReg &rn) {
  uint32_t Q = 1;
...
// Advanced SIMD copy
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdCopyElemIns(uint32_t op,
                                                         const VRegElem &vd,
                                                         const VRegElem &vn) {
  uint32_t Q = 1;
  uint32_t size = genSize(vd);
...
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimd3SameFp16(uint32_t U, uint32_t a,
                                                       uint32_t opcode,
                                                       const VRegVec &vd,
                                                       const VRegVec &vn,
                                                       const VRegVec &vm) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimd2RegMiscFp16(uint32_t U, uint32_t a, uint32_t opcode,
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimd3SameExtra(uint32_t U, uint32_t opcode, const VRegVec &vd,
...
// Advanced SIMD three same extra
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimd3SameExtraRotate(uint32_t U, uint32_t op32,
                                       const VRegVec &vd, const VRegVec &vn,
                                       const VRegVec &vm, uint32_t rotate) {
  uint32_t Q = genQ(vd);
  uint32_t size = genSize(vd);
...
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimd2RegMisc(uint32_t U,
                                                      uint32_t opcode,
                                                      const VRegVec &vd,
                                                      const VRegVec &vn) {
...
// Advanced SIMD two-register miscellaneous
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimd2RegMisc(uint32_t U, uint32_t opcode, const VRegVec &vd,
...
// Advanced SIMD two-register miscellaneous
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimd2RegMiscZero(uint32_t U,
                                                          uint32_t opcode,
                                                          const VRegVec &vd,
                                                          const VRegVec &vn,
                                                          uint32_t zero) {
...
// Advanced SIMD two-register miscellaneous
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimd2RegMiscSz(uint32_t U, uint32_t size, uint32_t opcode,
                                 const VRegVec &vd, const VRegVec &vn) {
  uint32_t Q = genQ(vd);
  uint32_t code =
      concat({F(Q, 30), F(U, 29), F(0xe, 24), F(size, 22), F(1, 21),
...
// Advanced SIMD two-register miscellaneous
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimd2RegMiscSz0x(uint32_t U,
                                                          uint32_t opcode,
                                                          const VRegVec &vd,
                                                          const VRegVec &vn) {
...
// Advanced SIMD two-register miscellaneous
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimd2RegMiscSz1x(uint32_t U,
                                                          uint32_t opcode,
                                                          const VRegVec &vd,
                                                          const VRegVec &vn) {
  uint32_t Q = genQ(vd);
...
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdAcrossLanes(uint32_t U,
                                                         uint32_t opcode,
                                                         const VRegSc &vd,
                                                         const VRegVec &vn) {
  uint32_t Q = genQ(vn);
...
// Advanced SIMD across lanes
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdAcrossLanesSz0x(uint32_t U, uint32_t opcode,
                                      const VRegSc &vd, const VRegVec &vn) {
  uint32_t Q = genQ(vn);
  uint32_t size = 0;
  uint32_t code =
...
// Advanced SIMD across lanes
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdAcrossLanesSz1x(uint32_t U, uint32_t opcode,
                                      const VRegSc &vd, const VRegVec &vn) {
  uint32_t Q = genQ(vn);
  uint32_t size = 2;
  uint32_t code =
...
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimd3Diff(uint32_t U, uint32_t opcode,
                                                   const VRegVec &vd,
                                                   const VRegVec &vn,
                                                   const VRegVec &vm) {
  ...
  uint32_t code = concat({F(Q, 30), F(U, 29), F(0xe, 24), F(size, 22), F(1, 21),
                          F(vm.getIdx(), 16), F(opcode, 12), F(vn.getIdx(), 5),
                          F(vd.getIdx(), 0)});
  dd(code);
}
...
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimd3Same(uint32_t U, uint32_t opcode,
                                                   const VRegVec &vd,
                                                   const VRegVec &vn,
                                                   const VRegVec &vm) {
  uint32_t Q = genQ(vd);
...
// Advanced SIMD three same
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimd3SameSz0x(uint32_t U, uint32_t opcode, const VRegVec &vd,
                                const VRegVec &vn, const VRegVec &vm) {
  uint32_t Q = genQ(vd);
  uint32_t size = genSize(vd) & 1;
  uint32_t code = concat({F(Q, 30), F(U, 29), F(0xe, 24), F(size, 22), F(1, 21),
...
// Advanced SIMD three same
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimd3SameSz1x(uint32_t U, uint32_t opcode, const VRegVec &vd,
                                const VRegVec &vn, const VRegVec &vm) {
  uint32_t Q = genQ(vd);
  uint32_t size = genSize(vd);
  uint32_t code = concat({F(Q, 30), F(U, 29), F(0xe, 24), F(size, 22), F(1, 21),
...
// Advanced SIMD three same
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimd3SameSz(uint32_t U, uint32_t size,
                                                     uint32_t opcode,
                                                     const VRegVec &vd,
                                                     const VRegVec &vn,
                                                     const VRegVec &vm) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdModiImmMoviMvni(uint32_t op, uint32_t o2,
                                      const VRegVec &vd, uint32_t imm,
                                      ShMod shmod, uint32_t sh) {
  uint32_t Q = genQ(vd);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdModiImmMoviMvniEnc(uint32_t Q, uint32_t op, uint32_t o2,
...
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdModiImmMoviMvni(uint32_t op,
                                                             uint32_t o2,
                                                             const VRegSc &vd,
                                                             uint64_t imm) {
  uint32_t Q = 0;
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdModiImmOrrBic(uint32_t op, uint32_t o2, const VRegVec &vd,
...
// Advanced SIMD modified immediate
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdModiImmFmov(uint32_t op,
                                                         uint32_t o2,
                                                         const VRegVec &vd,
                                                         double imm) {
  uint32_t Q = genQ(vd);
...
XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdShImm(uint32_t U, uint32_t opcode,
                                                   const VRegVec &vd,
                                                   const VRegVec &vn,
                                                   uint32_t sh) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdVecXindElemEnc(uint32_t Q, uint32_t U, uint32_t size,
  ...
  uint32_t code = concat({F(Q, 30), F(U, 29), F(0xf, 24), F(size, 22), F(L, 21),
                          F(M, 20), F(vmidx, 16), F(opcode, 12), F(H, 11),
                          F(vn.getIdx(), 5), F(vd.getIdx(), 0)});
  dd(code);
}

XBYAK_AARCH64_INLINE void CodeGenerator::AdvSimdVecXindElem(uint32_t U,
                                                         uint32_t opcode,
                                                         const VRegVec &vd,
                                                         const VRegVec &vn,
                                                         const VRegElem &vm) {
...
// Advanced SIMD vector x indexed element
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdVecXindElem(uint32_t U, uint32_t opcode,
                                  const VRegVec &vd, const VRegVec &vn,
                                  const VRegElem &vm, uint32_t rotate) {
  uint32_t Q = genQ(vd);
  uint32_t size = genSize(vd);
  uint32_t rot = rotate / 90;
...
XBYAK_AARCH64_INLINE void
CodeGenerator::AdvSimdVecXindElemSz(uint32_t U, uint32_t size, uint32_t opcode,
                                    const VRegVec &vd, const VRegVec &vn,
                                    const VRegElem &vm) {
  uint32_t Q = genQ(vd);
  AdvSimdVecXindElemEnc(Q, U, size, opcode, vd, vn, vm);
...
XBYAK_AARCH64_INLINE void CodeGenerator::Crypto3RegImm2(uint32_t opcode,
                                                     const VRegVec &vd,
                                                     const VRegVec &vn,
                                                     const VRegElem &vm) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::Crypto3RegSHA512(uint32_t O, uint32_t opcode, const VRegSc &vd,
                                const VRegSc &vn, const VRegVec &vm) {
  uint32_t code = concat({F(0x673, 21), F(vm.getIdx(), 16), F(1, 15), F(O, 14),
                          F(opcode, 10), F(vn.getIdx(), 5), F(vd.getIdx(), 0)});
  dd(code);
}
...
// Cryptographic three-register SHA 512
XBYAK_AARCH64_INLINE void
CodeGenerator::Crypto3RegSHA512(uint32_t O, uint32_t opcode, const VRegVec &vd,
                                const VRegVec &vn, const VRegVec &vm) {
  uint32_t code = concat({F(0x673, 21), F(vm.getIdx(), 16), F(1, 15), F(O, 14),
                          F(opcode, 10), F(vn.getIdx(), 5), F(vd.getIdx(), 0)});
  dd(code);
...
// XAR
XBYAK_AARCH64_INLINE void CodeGenerator::CryptoSHA(const VRegVec &vd,
                                                const VRegVec &vn,
                                                const VRegVec &vm,
                                                uint32_t imm6) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::Crypto4Reg(uint32_t Op0, const VRegVec &vd, const VRegVec &vn,
                          const VRegVec &vm, const VRegVec &va) {
  uint32_t code =
      concat({F(0x19c, 23), F(Op0, 21), F(vm.getIdx(), 16), F(va.getIdx(), 10),
              F(vn.getIdx(), 5), F(vd.getIdx(), 0)});
  dd(code);
}

// Cryptographic two-register SHA512
XBYAK_AARCH64_INLINE void CodeGenerator::Crypto2RegSHA512(uint32_t opcode,
                                                       const VRegVec &vd,
                                                       const VRegVec &vn) {
  uint32_t code = concat(
...
XBYAK_AARCH64_INLINE void
CodeGenerator::ConversionFpFix(uint32_t S, uint32_t type, uint32_t rmode,
                               uint32_t opcode, const VRegSc &vd,
                               const RReg &rn, uint32_t fbits) {
  uint32_t sf = genSf(rn);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::ConversionFpFix(uint32_t S, uint32_t type, uint32_t rmode,
                               uint32_t opcode, const RReg &rd,
                               const VRegSc &vn, uint32_t fbits) {
  uint32_t sf = genSf(rd);
  uint32_t scale = 64 - fbits;
...
XBYAK_AARCH64_INLINE void
CodeGenerator::ConversionFpInt(uint32_t sf, uint32_t S, uint32_t type,
                               uint32_t rmode, uint32_t opcode, const RReg &rd,
                               const VRegSc &vn) {
  uint32_t code = concat({F(sf, 31), F(S, 29), F(0xf, 25), F(type, 22),
...
XBYAK_AARCH64_INLINE void
CodeGenerator::ConversionFpInt(uint32_t sf, uint32_t S, uint32_t type,
                               uint32_t rmode, uint32_t opcode,
                               const VRegSc &vd, const RReg &rn) {
  uint32_t code = concat({F(sf, 31), F(S, 29), F(0xf, 25), F(type, 22),
                          F(1, 21), F(rmode, 19), F(opcode, 16),
                          F(rn.getIdx(), 5), F(vd.getIdx(), 0)});
  dd(code);
...
CodeGenerator::ConversionFpInt(uint32_t sf, uint32_t S, uint32_t type,
                               uint32_t rmode, uint32_t opcode,
                               const VRegElem &vd, const RReg &rn) {
  uint32_t code = concat({F(sf, 31), F(S, 29), F(0xf, 25), F(type, 22),
                          F(1, 21), F(rmode, 19), F(opcode, 16),
                          F(rn.getIdx(), 5), F(vd.getIdx(), 0)});
  dd(code);
...
XBYAK_AARCH64_INLINE void CodeGenerator::FpDataProc1Reg(uint32_t M, uint32_t S,
                                                     uint32_t type,
                                                     uint32_t opcode,
                                                     const VRegSc &vd,
                                                     const VRegSc &vn) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::FpComp(uint32_t M, uint32_t S,
                                             uint32_t type, uint32_t op,
                                             uint32_t opcode2, const VRegSc &vn,
                                             const VRegSc &vm) {
  uint32_t code = concat({F(M, 31), F(S, 29), F(0xf, 25), F(type, 22), F(1, 21),
                          F(vm.getIdx(), 16), F(op, 14), F(1, 13),
...
XBYAK_AARCH64_INLINE void CodeGenerator::FpComp(uint32_t M, uint32_t S,
  ...
  uint32_t code =
      concat({F(M, 31), F(S, 29), F(0xf, 25), F(type, 22), F(1, 21), F(op, 14),
              F(1, 13), F(vn.getIdx(), 5), F(opcode2, 0)});
  dd(code);
}

// Floating-piont immediate
XBYAK_AARCH64_INLINE void CodeGenerator::FpImm(uint32_t M, uint32_t S,
                                            uint32_t type, const VRegSc &vd,
                                            double imm) {
  uint32_t imm8 = compactImm(imm, vd.getBit());
  uint32_t code = concat({F(M, 31), F(S, 29), F(0xf, 25), F(type, 22), F(1, 21),
...
XBYAK_AARCH64_INLINE void CodeGenerator::FpCondComp(uint32_t M, uint32_t S,
                                                 uint32_t type, uint32_t op,
                                                 const VRegSc &vn,
                                                 const VRegSc &vm,
                                                 uint32_t nzcv, Cond cond) {
  uint32_t code = concat({F(M, 31), F(S, 29), F(0xf, 25), F(type, 22), F(1, 21),
                          F(vm.getIdx(), 16), F(cond, 12), F(1, 10),
...
XBYAK_AARCH64_INLINE void
CodeGenerator::FpDataProc2Reg(uint32_t M, uint32_t S, uint32_t type,
                              uint32_t opcode, const VRegSc &vd,
                              const VRegSc &vn, const VRegSc &vm) {
  uint32_t code = concat({F(M, 31), F(S, 29), F(0xf, 25), F(type, 22), F(1, 21),
                          F(vm.getIdx(), 16), F(opcode, 12), F(2, 10),
                          F(vn.getIdx(), 5), F(vd.getIdx(), 0)});
  dd(code);
}

// Floating-piont conditional select
XBYAK_AARCH64_INLINE void CodeGenerator::FpCondSel(uint32_t M, uint32_t S,
                                                uint32_t type, const VRegSc &vd,
                                                const VRegSc &vn,
                                                const VRegSc &vm, Cond cond) {
  uint32_t code = concat({F(M, 31), F(S, 29), F(0xf, 25), F(type, 22), F(1, 21),
                          F(vm.getIdx(), 16), F(cond, 12), F(3, 10),
                          F(vn.getIdx(), 5), F(vd.getIdx(), 0)});
  dd(code);
}

// Floating-piont data-processing (3 source)
XBYAK_AARCH64_INLINE void CodeGenerator::FpDataProc3Reg(
    uint32_t M, uint32_t S, uint32_t type, uint32_t o1, uint32_t o0,
    const VRegSc &vd, const VRegSc &vn, const VRegSc &vm, const VRegSc &va) {
  uint32_t code =
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIntBinArPred(uint32_t opc, uint32_t type, const _ZReg &zd,
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveBitwiseLOpPred(uint32_t opc,
                                                        const _ZReg &zd,
                                                        const _PReg &pg,
                                                        const _ZReg &zn) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveIntAddSubVecPred(uint32_t opc,
                                                          const _ZReg &zd,
                                                          const _PReg &pg,
                                                          const _ZReg &zn) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIntMinMaxDiffPred(uint32_t opc, uint32_t U, const _ZReg &zd,
                                    const _PReg &pg, const _ZReg &zn) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIntMultDivVecPred(uint32_t opc, uint32_t U, const _ZReg &zd,
                                    const _PReg &pg, const _ZReg &zn) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIntReduction(uint32_t opc, uint32_t type, const Reg &rd,
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveBitwiseLReductPred(uint32_t opc,
                                                            const VRegSc &vd,
                                                            const _PReg &pg,
                                                            const _ZReg &zn) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveConstPrefPred(uint32_t opc,
                                                       const _ZReg &zd,
                                                       const _PReg &pg,
                                                       const _ZReg &zn) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIntAddReductPred(uint32_t opc, uint32_t U, const VRegSc &vd,
                                   const _PReg &pg, const _ZReg &zn) {
  SveIntReduction((opc << 1 | U), 0, vd, pg, zn);
}

// SVE integer min/max reduction (predicated)
XBYAK_AARCH64_INLINE void CodeGenerator::SveIntMinMaxReductPred(uint32_t opc,
                                                             uint32_t U,
                                                             const VRegSc &vd,
                                                             const _PReg &pg,
                                                             const _ZReg &zn) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveBitShPred(uint32_t opc, uint32_t type,
                                                   const _ZReg &zdn,
                                                   const _PReg &pg,
                                                   const _ZReg &zm) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveBitwiseShByImmPred(uint32_t opc,
                                                            const _ZReg &zdn,
                                                            const _PReg &pg,
                                                            uint32_t amount) {
  bool lsl = (opc == 3);
  ...
  uint32_t code =
      concat({F(0x4, 24), F(tszh, 22), F(0, 19), F(opc, 16), F(4, 13),
              F(pg.getIdx(), 10), F(tszl, 8), F(imm3, 5), F(zdn.getIdx(), 0)});
  dd(code);
}

// SVE bitwise shift by vector (predicated)
XBYAK_AARCH64_INLINE void CodeGenerator::SveBitwiseShVecPred(uint32_t opc,
                                                          const _ZReg &zdn,
                                                          const _PReg &pg,
                                                          const _ZReg &zm) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveBitwiseShWElemPred(uint32_t opc,
                                                            const _ZReg &zdn,
                                                            const _PReg &pg,
                                                            const _ZReg &zm) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIntUnaryArPred(uint32_t opc, uint32_t type, const _ZReg &zd,
                                 const _PReg &pg, const _ZReg &zn) {
  uint32_t size = genSize(zd);
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code =
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveBitwiseUnaryOpPred(uint32_t opc,
                                                            const _ZReg &zdn,
                                                            const _PReg &pg,
                                                            const _ZReg &zm) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveIntUnaryOpPred(uint32_t opc,
                                                        const _ZReg &zdn,
                                                        const _PReg &pg,
                                                        const _ZReg &zm) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveIntMultAccumPred(uint32_t opc,
                                                          const _ZReg &zda,
                                                          const _PReg &pg,
                                                          const _ZReg &zn,
                                                          const _ZReg &zm) {
  ...
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code =
      concat({F(0x4, 24), F(size, 22), F(zm.getIdx(), 16), F(1, 14), F(opc, 13),
              F(pg.getIdx(), 10), F(zn.getIdx(), 5), F(zda.getIdx(), 0)});
  dd(code);
}

// SVE integer multiply-add writeing multiplicand (predicated)
XBYAK_AARCH64_INLINE void CodeGenerator::SveIntMultAddPred(uint32_t opc,
                                                        const _ZReg &zdn,
                                                        const _PReg &pg,
                                                        const _ZReg &zm,
                                                        const _ZReg &za) {
  ...
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code =
      concat({F(0x4, 24), F(size, 22), F(zm.getIdx(), 16), F(3, 14), F(opc, 13),
              F(pg.getIdx(), 10), F(za.getIdx(), 5), F(zdn.getIdx(), 0)});
  dd(code);
}

// SVE integer add/subtract vectors (unpredicated)
XBYAK_AARCH64_INLINE void CodeGenerator::SveIntAddSubUnpred(uint32_t opc,
                                                         const _ZReg &zd,
                                                         const _ZReg &zn,
                                                         const _ZReg &zm) {
  uint32_t size = genSize(zd);
  uint32_t code = concat({F(0x4, 24), F(size, 22), F(1, 21), F(zm.getIdx(), 16),
                          F(opc, 10), F(zn.getIdx(), 5), F(zd.getIdx(), 0)});
  dd(code);
}

// SVE bitwise logical operations (unpredicated)
XBYAK_AARCH64_INLINE void CodeGenerator::SveBitwiseLOpUnpred(uint32_t opc,
                                                          const _ZReg &zd,
                                                          const _ZReg &zn,
                                                          const _ZReg &zm) {
  uint32_t code = concat({F(0x4, 24), F(opc, 22), F(1, 21), F(zm.getIdx(), 16),
                          F(0xc, 10), F(zn.getIdx(), 5), F(zd.getIdx(), 0)});
  dd(code);
}

// SVE index generation (immediate start, immediate increment)
XBYAK_AARCH64_INLINE void CodeGenerator::SveIndexGenImmImmInc(const _ZReg &zd,
                                                           int32_t imm1,
                                                           int32_t imm2) {
  uint32_t size = genSize(zd);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveIndexGenImmRegInc(const _ZReg &zd,
                                                           int32_t imm,
                                                           const RReg &rm) {
  uint32_t size = genSize(zd);
  uint32_t imm5 = imm & ones(5);
  ...
  uint32_t code = concat({F(0x4, 24), F(size, 22), F(1, 21), F(rm.getIdx(), 16),
                          F(0x12, 10), F(imm5, 5), F(zd.getIdx(), 0)});
  dd(code);
}

// SVE index generation (register start, immediate increment)
XBYAK_AARCH64_INLINE void CodeGenerator::SveIndexGenRegImmInc(const _ZReg &zd,
                                                           const RReg &rn,
                                                           int32_t imm) {
  uint32_t size = genSize(zd);
  uint32_t imm5 = imm & ones(5);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveIndexGenRegRegInc(const _ZReg &zd,
                                                           const RReg &rn,
                                                           const RReg &rm) {
  uint32_t size = genSize(zd);
  uint32_t code = concat({F(0x4, 24), F(size, 22), F(1, 21), F(rm.getIdx(), 16),
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveStackFrameAdjust(uint32_t op,
                                                          const XReg &xd,
                                                          const XReg &xn,
                                                          int32_t imm) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveStackFrameSize(uint32_t op,
                                                        uint32_t opc2,
                                                        const XReg &xd,
                                                        int32_t imm) {
  uint32_t imm6 = imm & ones(6);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveBitwiseShByImmUnpred(uint32_t opc,
                                                              const _ZReg &zd,
                                                              const _ZReg &zn,
                                                              uint32_t amount) {
  bool lsl = (opc == 3);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveBitwiseShByWideElemUnPred(uint32_t opc, const _ZReg &zd,
                                            const _ZReg &zn, const _ZReg &zm) {
  uint32_t size = genSize(zd);
  uint32_t code =
      concat({F(0x4, 24), F(size, 22), F(1, 21), F(zm.getIdx(), 16), F(0x8, 12),
              F(opc, 10), F(zn.getIdx(), 5), F(zd.getIdx(), 0)});
  dd(code);
}

// SVE address generation
XBYAK_AARCH64_INLINE void CodeGenerator::SveAddressGen(const _ZReg &zd,
                                                    const AdrVec &adr) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIntMiscUnpred(uint32_t size, uint32_t opc, uint32_t type,
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveConstPrefUnpred(uint32_t opc,
                                                         uint32_t opc2,
                                                         const _ZReg &zd,
                                                         const _ZReg &zn) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveFpExpAccel(uint32_t opc, const _ZReg &zd, const _ZReg &zn) {
  uint32_t size = genSize(zd);
  SveIntMiscUnpred(size, opc, 2, zd, zn);
}

// SVE floating-point trig select coefficient
XBYAK_AARCH64_INLINE void CodeGenerator::SveFpTrigSelCoef(uint32_t opc,
                                                       const _ZReg &zd,
                                                       const _ZReg &zn,
                                                       const _ZReg &zm) {
  uint32_t size = genSize(zd);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveElemCountGrp(uint32_t size, uint32_t op, uint32_t type1,
                               uint32_t type2, const Reg &rd, Pattern pat,
  ...
  uint32_t code =
      concat({F(0x4, 24), F(size, 22), F(type1, 20), F(imm4, 16), F(type2, 11),
              F(op, 10), F(pat, 5), F(rd.getIdx(), 0)});
  dd(code);
}

// SVE element count
XBYAK_AARCH64_INLINE void CodeGenerator::SveElemCount(uint32_t size, uint32_t op,
                                                   const XReg &xd, Pattern pat,
                                                   ExtMod mod, uint32_t imm) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIncDecRegByElemCount(uint32_t size, uint32_t D,
                                       const XReg &xd, Pattern pat, ExtMod mod,
                                       uint32_t imm) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIncDecVecByElemCount(uint32_t size, uint32_t D,
                                       const _ZReg &zd, Pattern pat, ExtMod mod,
                                       uint32_t imm) {
  SveElemCountGrp(size, D, 3, 0x18, zd, pat, mod, imm);
}

// SVE saturating inc/dec register by element count
XBYAK_AARCH64_INLINE void CodeGenerator::SveSatuIncDecRegByElemCount(
    uint32_t size, uint32_t D, uint32_t U, const RReg &rdn, Pattern pat,
    ExtMod mod, uint32_t imm) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveSatuIncDecVecByElemCount(
    uint32_t size, uint32_t D, uint32_t U, const _ZReg &zdn, Pattern pat,
    ExtMod mod, uint32_t imm) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveBitwiseImm(uint32_t opc, const _ZReg &zd, uint64_t imm) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveBitwiseLogicalImmUnpred(uint32_t opc, const _ZReg &zdn,
                                          uint64_t imm) {
  SveBitwiseImm(opc, zdn, imm);
}

// SVE broadcast bitmask immediate
XBYAK_AARCH64_INLINE void CodeGenerator::SveBcBitmaskImm(const _ZReg &zdn,
                                                      uint64_t imm) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveCopyFpImmPred(const _ZReg &zd, const _PReg &pg, double imm) {
  uint32_t size = genSize(zd);
  uint32_t imm8 = compactImm(imm, zd.getBit());
  uint32_t code = concat({F(0x5, 24), F(size, 22), F(1, 20), F(pg.getIdx(), 16),
                          F(6, 13), F(imm8, 5), F(zd.getIdx(), 0)});
  dd(code);
}

// SVE copy integer immediate (predicated)
XBYAK_AARCH64_INLINE void CodeGenerator::SveCopyIntImmPred(const _ZReg &zd,
                                                        const _PReg &pg,
                                                        uint32_t imm, ShMod mod,
                                                        uint32_t sh) {
  verifyIncList(mod, {LSL}, ERR_ILLEGAL_SHMOD);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveExtVec(const _ZReg &zdn,
                                                const _ZReg &zm, uint32_t imm) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SvePerVecUnpred(uint32_t size, uint32_t type1, uint32_t type2,
                               const _ZReg &zd, const Reg &rn) {
  uint32_t code = concat({F(0x5, 24), F(size, 22), F(1, 21), F(type1, 16),
                          F(type2, 10), F(rn.getIdx(), 5), F(zd.getIdx(), 0)});
  dd(code);
}

// SVE broadcast general register
XBYAK_AARCH64_INLINE void CodeGenerator::SveBcGeneralReg(const _ZReg &zd,
                                                      const RReg &rn) {
  uint32_t size = genSize(zd);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveBcIndexedElem(const _ZReg &zd,
                                                       const ZRegElem &zn) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveInsSimdFpSclarReg(const _ZReg &zdn,
                                                           const VRegSc &vm) {
  uint32_t size = genSize(zdn);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveInsGeneralReg(const _ZReg &zdn,
                                                       const RReg &rm) {
  uint32_t size = genSize(zdn);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveRevVecElem(const _ZReg &zd,
                                                    const _ZReg &zn) {
  uint32_t size = genSize(zd);
...
// SVE table lookup
XBYAK_AARCH64_INLINE void CodeGenerator::SveTableLookup(const _ZReg &zd,
                                                     const _ZReg &zn,
                                                     const _ZReg &zm) {
  uint32_t size = genSize(zd);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveUnpackVecElem(uint32_t U, uint32_t H,
                                                       const _ZReg &zd,
                                                       const _ZReg &zn) {
  uint32_t size = genSize(zd);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SvePermutePredElem(uint32_t opc, uint32_t H, const _PReg &pd,
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveRevPredElem(const _PReg &pd,
                                                     const _PReg &pn) {
  uint32_t size = genSize(pd);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveUnpackPredElem(uint32_t H, const _PReg &pd, const _PReg &pn) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SvePermuteVecElem(uint32_t opc,
                                                        const _ZReg &zd,
                                                        const _ZReg &zn,
                                                        const _ZReg &zm) {
  uint32_t size = genSize(zd);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveCompressActElem(const _ZReg &zd,
                                                         const _PReg &pg,
                                                         const _ZReg &zn) {
  uint32_t size = genSize(zd);
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code =
      concat({F(0x5, 24), F(size, 22), F(1, 21), F(0xc, 13), F(pg.getIdx(), 10),
              F(zn.getIdx(), 5), F(zd.getIdx(), 0)});
  dd(code);
}

// SVE conditionally broaccast element to vector
XBYAK_AARCH64_INLINE void CodeGenerator::SveCondBcElemToVec(uint32_t B,
                                                         const _ZReg &zdn,
                                                         const _PReg &pg,
                                                         const _ZReg &zm) {
  uint32_t size = genSize(zdn);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveCondExtElemToSimdFpScalar(uint32_t B, const VRegSc &vdn,
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveCondExtElemToGeneralReg(uint32_t B, const RReg &rdn,
                                          const _PReg &pg, const _ZReg &zm) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveCopySimdFpScalarToVecPred(const _ZReg &zd, const _PReg &pg,
                                            const VRegSc &vn) {
  uint32_t size = genSize(zd);
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code =
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveCopyGeneralRegToVecPred(const _ZReg &zd, const _PReg &pg,
                                          const RReg &rn) {
  uint32_t size = genSize(zd);
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code =
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveExtElemToSimdFpScalar(uint32_t B, const VRegSc &vd,
                                        const _PReg &pg, const _ZReg &zn) {
  uint32_t size = genSize(vd);
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code =
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveExtElemToGeneralReg(uint32_t B,
                                                             const RReg &rd,
                                                             const _PReg &pg,
                                                             const _ZReg &zn) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveRevWithinElem(uint32_t opc,
                                                       const _ZReg &zd,
                                                       const _PReg &pg,
                                                       const _ZReg &zn) {
  uint32_t size = genSize(zd);
...
// SVE vector splice
XBYAK_AARCH64_INLINE void CodeGenerator::SveSelVecSplice(const _ZReg &zd,
                                                      const _PReg &pg,
                                                      const _ZReg &zn) {
  uint32_t size = genSize(zd);
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveSelVecElemPred(const _ZReg &zd,
                                                        const _PReg &pg,
                                                        const _ZReg &zn,
                                                        const _ZReg &zm) {
  uint32_t size = genSize(zd);
  uint32_t code =
      concat({F(0x5, 24), F(size, 22), F(1, 21), F(zm.getIdx(), 16), F(0x3, 14),
              F(pg.getIdx(), 10), F(zn.getIdx(), 5), F(zd.getIdx(), 0)});
  dd(code);
}
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIntCompVecGrp(uint32_t opc, uint32_t ne, const _PReg &pd,
                                const _PReg &pg, const _ZReg &zn,
                                const _ZReg &zm) {
  uint32_t size = genSize(pd);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIntCompVec(uint32_t op, uint32_t o2, uint32_t ne,
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIntCompWideElem(uint32_t op, uint32_t o2, uint32_t ne,
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIntCompUImm(uint32_t lt, uint32_t ne, const _PReg &pd,
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SvePredLOp(uint32_t op, uint32_t S, uint32_t o2, uint32_t o3,
                          const _PReg &pd, const _PReg &pg, const _PReg &pn,
                          const _PReg &pm) {
  uint32_t code = concat({F(0x25, 24), F(op, 23), F(S, 22), F(pm.getIdx(), 16),
                          F(1, 14), F(pg.getIdx(), 10), F(o2, 9),
                          F(pn.getIdx(), 5), F(o3, 4), F(pd.getIdx(), 0)});
  dd(code);
}

// SVE propagate break from previous partition
XBYAK_AARCH64_INLINE void
CodeGenerator::SvePropagateBreakPrevPtn(uint32_t op, uint32_t S, uint32_t B,
                                        const _PReg &pd, const _PReg &pg,
                                        const _PReg &pn, const _PReg &pm) {
  uint32_t code = concat({F(0x25, 24), F(op, 23), F(S, 22), F(pm.getIdx(), 16),
                          F(3, 14), F(pg.getIdx(), 10), F(pn.getIdx(), 5),
                          F(B, 4), F(pd.getIdx(), 0)});
  dd(code);
}
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SvePartitionBreakCond(uint32_t B, uint32_t S, const _PReg &pd,
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SvePropagateBreakNextPart(uint32_t S, const _PReg &pdm,
                                         const _PReg &pg, const _PReg &pn) {
  uint32_t code =
...
XBYAK_AARCH64_INLINE void CodeGenerator::SvePredFirstAct(uint32_t op, uint32_t S,
                                                      const _PReg &pdn,
                                                      const _PReg &pg) {
  uint32_t code = concat({F(0x25, 24), F(op, 23), F(S, 22), F(3, 19), F(3, 14),
                          F(pg.getIdx(), 5), F(pdn.getIdx(), 0)});
  dd(code);
}

// SVE predicate initialize
XBYAK_AARCH64_INLINE void CodeGenerator::SvePredInit(uint32_t S, const _PReg &pd,
                                                  Pattern pat) {
  uint32_t size = genSize(pd);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SvePredNextAct(const _PReg &pdn,
                                                     const _PReg &pg) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SvePredReadFFRPred(uint32_t op,
                                                         uint32_t S,
                                                         const _PReg &pd,
                                                         const _PReg &pg) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SvePredReadFFRUnpred(uint32_t op, uint32_t S, const _PReg &pd) {
  uint32_t code = concat({F(0x25, 24), F(op, 23), F(S, 22), F(3, 19),
...
// SVE predicate test
XBYAK_AARCH64_INLINE void CodeGenerator::SvePredTest(uint32_t op, uint32_t S,
                                                  uint32_t opc2,
                                                  const _PReg &pg,
                                                  const _PReg &pn) {
  uint32_t code = concat({F(0x25, 24), F(op, 23), F(S, 22), F(2, 19), F(3, 14),
                          F(pg.getIdx(), 10), F(pn.getIdx(), 5), F(opc2, 0)});
  dd(code);
}

// SVE predicate zero
XBYAK_AARCH64_INLINE void CodeGenerator::SvePredZero(uint32_t op, uint32_t S,
                                                  const _PReg &pd) {
  uint32_t code = concat({F(0x25, 24), F(op, 23), F(S, 22), F(3, 19), F(7, 13),
                          F(1, 10), F(pd.getIdx(), 0)});
  dd(code);
}

// SVE integer compare with signed immediate
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIntCompSImm(uint32_t op, uint32_t o2, uint32_t ne,
                              const _PReg &pd, const _PReg &pg, const _ZReg &zn,
                              int32_t imm) {
  uint32_t size = genSize(pd);
  uint32_t imm5 = imm & ones(5);
...
// SVE predicate count
XBYAK_AARCH64_INLINE void CodeGenerator::SvePredCount(uint32_t opc, uint32_t o2,
                                                   const RReg &rd,
                                                   const _PReg &pg,
                                                   const _PReg &pn) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIncDecPredCount(uint32_t size, uint32_t op, uint32_t D,
                                  uint32_t opc2, uint32_t type1, uint32_t type2,
                                  const Reg &rdn, const _PReg &pg) {
  uint32_t code =
      concat({F(0x25, 24), F(size, 22), F(type1, 18), F(op, 17), F(D, 16),
              F(type2, 11), F(opc2, 9), F(pg.getIdx(), 5), F(rdn.getIdx(), 0)});
  dd(code);
}

// SVE inc/dec register by predicate count
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIncDecRegByPredCount(uint32_t op, uint32_t D, uint32_t opc2,
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIncDecVecByPredCount(uint32_t op, uint32_t D, uint32_t opc2,
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveSatuIncDecRegByPredCount(uint32_t D, uint32_t U, uint32_t op,
                                           const RReg &rdn, const _PReg &pg) {
  uint32_t sf = genSf(rdn);
  uint32_t size = genSize(pg);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveSatuIncDecVecByPredCount(uint32_t D, uint32_t U, uint32_t opc,
                                           const _ZReg &zdn, const _PReg &pg) {
  uint32_t size = genSize(zdn);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveFFRWritePred(uint32_t opc,
                                                      const _PReg &pn) {
  uint32_t code = concat(
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveCondTermScalars(uint32_t op,
                                                         uint32_t ne,
                                                         const RReg &rn,
                                                         const RReg &rm) {
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIntCompScalarCountAndLimit(uint32_t U, uint32_t lt,
                                             uint32_t eq, const _PReg &pd,
                                             const RReg &rn, const RReg &rm) {
  uint32_t size = genSize(pd);
  uint32_t sf = genSf(rn);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveBcFpImmUnpred(uint32_t opc,
                                                       uint32_t o2,
                                                       const _ZReg &zd,
                                                       double imm) {
  uint32_t size = genSize(zd);
  uint32_t imm8 = compactImm(imm, zd.getBit());
  uint32_t code = concat({F(0x25, 24), F(size, 22), F(7, 19), F(opc, 17),
                          F(7, 14), F(o2, 13), F(imm8, 5), F(zd.getIdx(), 0)});
  dd(code);
}

// SVE broadcast integer immediate (unpredicated)
XBYAK_AARCH64_INLINE void CodeGenerator::SveBcIntImmUnpred(uint32_t opc,
                                                        const _ZReg &zd,
                                                        int32_t imm, ShMod mod,
                                                        uint32_t sh) {
  verifyIncList(mod, {LSL}, ERR_ILLEGAL_SHMOD);
  verifyIncList(sh, {0, 8}, ERR_ILLEGAL_CONST_VALUE);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIntAddSubImmUnpred(uint32_t opc, const _ZReg &zdn,
                                     uint32_t imm, ShMod mod, uint32_t sh) {
  verifyIncList(mod, {LSL}, ERR_ILLEGAL_SHMOD);
  verifyIncList(sh, {0, 8}, ERR_ILLEGAL_CONST_VALUE);
  verifyIncRange(imm, 0, 255, ERR_ILLEGAL_IMM_RANGE);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveIntMinMaxImmUnpred(uint32_t opc,
                                                            uint32_t o2,
                                                            const _ZReg &zdn,
                                                            int32_t imm) {
  if ((opc & 0x1))
  ...
  uint32_t size = genSize(zdn);
  uint32_t imm8 = imm & ones(8);
  uint32_t code = concat({F(0x25, 24), F(size, 22), F(5, 19), F(opc, 16),
                          F(3, 14), F(o2, 13), F(imm8, 5), F(zdn.getIdx(), 0)});
  dd(code);
}

// SVE integer multiply immediate (unpredicated)
XBYAK_AARCH64_INLINE void CodeGenerator::SveIntMultImmUnpred(uint32_t opc,
                                                          uint32_t o2,
                                                          const _ZReg &zdn,
                                                          int32_t imm) {
  uint32_t size = genSize(zdn);
  uint32_t imm8 = imm & ones(8);
  verifyIncRange(imm, -128, 127, ERR_ILLEGAL_IMM_RANGE, true);
  uint32_t code = concat({F(0x25, 24), F(size, 22), F(6, 19), F(opc, 16),
                          F(3, 14), F(o2, 13), F(imm8, 5), F(zdn.getIdx(), 0)});
  dd(code);
}

// SVE integer dot product (unpredicated)
XBYAK_AARCH64_INLINE void CodeGenerator::SveIntDotProdcutUnpred(uint32_t U,
                                                             const _ZReg &zda,
                                                             const _ZReg &zn,
                                                             const _ZReg &zm) {
  uint32_t size = genSize(zda);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveIntDotProdcutIndexed(uint32_t size, uint32_t U,
                                       const _ZReg &zda, const _ZReg &zn,
                                       const ZRegElem &zm) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveFpComplexAddPred(const _ZReg &zdn,
                                                          const _PReg &pg,
                                                          const _ZReg &zm,
                                                          uint32_t ct) {
  uint32_t size = genSize(zdn);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveFpComplexMultAddPred(const _ZReg &zda,
                                                              const _PReg &pg,
                                                              const _ZReg &zn,
                                                              const _ZReg &zm,
                                                              uint32_t ct) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveFpMultAddIndexed(uint32_t op,
                                                          const _ZReg &zda,
                                                          const _ZReg &zn,
                                                          const ZRegElem &zm) {
  uint32_t zm_idx = zm.getIdx();
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveFpComplexMultAddIndexed(const _ZReg &zda, const _ZReg &zn,
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveFpMultIndexed(const _ZReg &zd,
                                                       const _ZReg &zn,
                                                       const ZRegElem &zm) {
  uint32_t zm_idx = zm.getIdx();
  uint32_t zm_bit = zm.getBit();
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveFpRecurReduct(uint32_t opc,
                                                       const VRegSc vd,
                                                       const _PReg &pg,
                                                       const _ZReg &zn) {
  uint32_t size = genSize(vd);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveFpReciproEstUnPred(uint32_t opc,
                                                            const _ZReg &zd,
                                                            const _ZReg &zn) {
  uint32_t size = genSize(zd);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveFpCompWithZero(uint32_t eq, uint32_t lt, uint32_t ne,
                                 const _PReg &pd, const _PReg &pg,
                                 const _ZReg &zn, double zero) {
  uint32_t size = genSize(pd);
  verifyIncList(std::lround(zero * 10), {0}, ERR_ILLEGAL_CONST_VALUE);
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveFpSerialReductPred(uint32_t opc,
                                                            const VRegSc vdn,
                                                            const _PReg &pg,
                                                            const _ZReg &zm) {
  uint32_t size = genSize(vdn);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveFpArithmeticUnpred(uint32_t opc,
                                                            const _ZReg &zd,
                                                            const _ZReg &zn,
                                                            const _ZReg &zm) {
  uint32_t size = genSize(zd);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveFpArithmeticPred(uint32_t opc,
                                                          const _ZReg &zdn,
                                                          const _PReg &pg,
                                                          const _ZReg &zm) {
  uint32_t size = genSize(zdn);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveFpArithmeticImmPred(uint32_t opc,
                                                             const _ZReg &zdn,
                                                             const _PReg &pg,
                                                             float ct) {
  uint32_t size = genSize(zdn);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveFpTrigMultAddCoef(const _ZReg &zdn,
                                                           const _ZReg &zm,
                                                           uint32_t imm) {
  uint32_t size = genSize(zdn);
  uint32_t imm3 = imm & ones(3);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveFpCvtPrecision(uint32_t opc, uint32_t opc2, const _ZReg &zd,
                                 const _PReg &pg, const _ZReg &zn) {
  uint32_t code =
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveFpCvtToInt(uint32_t opc, uint32_t opc2,
                                                    uint32_t U, const _ZReg &zd,
                                                    const _PReg &pg,
                                                    const _ZReg &zn) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveFpRoundToIntegral(uint32_t opc,
                                                           const _ZReg &zd,
                                                           const _PReg &pg,
                                                           const _ZReg &zn) {
  uint32_t size = genSize(zd);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveFpUnaryOp(uint32_t opc,
                                                   const _ZReg &zd,
                                                   const _PReg &pg,
                                                   const _ZReg &zn) {
  uint32_t size = genSize(zd);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveIntCvtToFp(uint32_t opc, uint32_t opc2,
                                                    uint32_t U, const _ZReg &zd,
                                                    const _PReg &pg,
                                                    const _ZReg &zn) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveFpCompVec(uint32_t op, uint32_t o2,
                                                   uint32_t o3, const _PReg &pd,
                                                   const _PReg &pg,
                                                   const _ZReg &zn,
                                                   const _ZReg &zm) {
  uint32_t size = genSize(pd);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveFpMultAccumAddend(uint32_t opc,
                                                           const _ZReg &zda,
                                                           const _PReg &pg,
                                                           const _ZReg &zn,
                                                           const _ZReg &zm) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveFpMultAccumMulti(uint32_t opc,
                                                          const _ZReg &zdn,
                                                          const _PReg &pg,
                                                          const _ZReg &zm,
                                                          const _ZReg &za) {
  uint32_t size = genSize(zdn);
  uint32_t code = concat(
      {F(0x65, 24), F(size, 22), F(1, 21), F(za.getIdx(), 16), F(1, 15),
       F(opc, 13), F(pg.getIdx(), 10), F(zm.getIdx(), 5), F(zdn.getIdx(), 0)});
  dd(code);
}

// SVE 32-bit gather load (scalar plus 32-bit unscaled offsets)
XBYAK_AARCH64_INLINE void
CodeGenerator::Sve32GatherLdSc32U(uint32_t msz, uint32_t U, uint32_t ff,
...
XBYAK_AARCH64_INLINE void
CodeGenerator::Sve32GatherLdVecImm(uint32_t msz, uint32_t U, uint32_t ff,
                                   const _ZReg &zt, const _PReg &pg,
...
XBYAK_AARCH64_INLINE void
CodeGenerator::Sve32GatherLdHSc32S(uint32_t U, uint32_t ff, const _ZReg &zt,
...
XBYAK_AARCH64_INLINE void
CodeGenerator::Sve32GatherLdWSc32S(uint32_t U, uint32_t ff, const _ZReg &zt,
                                   const _PReg &pg, const AdrSc32S &adr) {
  uint32_t xs = (adr.getMod() == SXTW) ? 1 : 0;
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
...
XBYAK_AARCH64_INLINE void CodeGenerator::Sve32GatherPfSc32S(PrfopSve prfop_sve,
                                                         uint32_t msz,
                                                         const _PReg &pg,
                                                         const AdrSc32S &adr) {
  uint32_t xs = (adr.getMod() == SXTW) ? 1 : 0;
...
XBYAK_AARCH64_INLINE void
CodeGenerator::Sve32GatherPfVecImm(PrfopSve prfop_sve, uint32_t msz,
                                   const _PReg &pg, const AdrVecImm32 &adr) {
  uint32_t imm5 = (adr.getImm() >> msz) & ones(5);
  ...
  uint32_t code =
      concat({F(0x42, 25), F(msz, 23), F(imm5, 16), F(7, 13),
              F(pg.getIdx(), 10), F(adr.getZn().getIdx(), 5), F(prfop_sve, 0)});
  dd(code);
}

// SVE 32-bit contiguous prefetch (scalar plus immediate)
XBYAK_AARCH64_INLINE void CodeGenerator::Sve32ContiPfScImm(PrfopSve prfop_sve,
                                                        uint32_t msz,
                                                        const _PReg &pg,
                                                        const AdrScImm &adr) {
  ...
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code =
      concat({F(0x42, 25), F(7, 22), F(imm6, 16), F(msz, 13),
...
XBYAK_AARCH64_INLINE void CodeGenerator::Sve32ContiPfScSc(PrfopSve prfop_sve,
                                                       uint32_t msz,
                                                       const _PReg &pg,
                                                       const AdrScSc &adr) {
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  ...
  uint32_t code =
      concat({F(0x42, 25), F(msz, 23), F(adr.getXm().getIdx(), 16), F(6, 13),
              F(pg.getIdx(), 10), F(adr.getXn().getIdx(), 5), F(prfop_sve, 0)});
  dd(code);
}

// SVE load and broadcast element
XBYAK_AARCH64_INLINE void CodeGenerator::SveLoadAndBcElem(uint32_t dtypeh,
                                                       uint32_t dtypel,
                                                       const _ZReg &zt,
                                                       const _PReg &pg,
                                                       const AdrScImm &adr) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveLoadPredReg(const _PReg &pt,
                                                     const AdrScImm &adr) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveLoadPredVec(const _ZReg &zt,
                                                     const AdrScImm &adr) {
  int32_t imm = adr.getSimm();
  uint32_t imm9h = field(imm, 8, 3);
  uint32_t imm9l = field(imm, 2, 0);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveContiFFLdScSc(uint32_t dtype,
                                                       const _ZReg &zt,
                                                       const _PReg &pg,
                                                       const AdrScSc &adr) {
  if (adr.getInitMod()) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveContiLdScImm(uint32_t dtype,
                                                      const _ZReg &zt,
                                                      const _PReg &pg,
                                                      const AdrScImm &adr) {
  int32_t imm = adr.getSimm();
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveContiLdScImm(uint32_t dtype,
  ...
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code =
      concat({F(0x52, 25), F(dtype, 21), F(0, 16), F(5, 13), F(pg.getIdx(), 10),
              F(adr.getXn().getIdx(), 5), F(zt.getIdx(), 0)});
  dd(code);
}

// SVE contiguous load (scalar plus scalar)
XBYAK_AARCH64_INLINE void CodeGenerator::SveContiLdScSc(uint32_t dtype,
                                                     const _ZReg &zt,
                                                     const _PReg &pg,
                                                     const AdrScSc &adr) {
  verifyIncList(adr.getSh(), {genSize(dtype)}, ERR_ILLEGAL_CONST_VALUE);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveContiNFLdScImm(uint32_t dtype,
                                                        const _ZReg &zt,
                                                        const _PReg &pg,
                                                        const AdrScImm &adr) {
  int32_t imm = adr.getSimm();
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveContiNTLdScImm(uint32_t msz,
                                                        const _ZReg &zt,
                                                        const _PReg &pg,
                                                        const AdrScImm &adr) {
  int32_t imm = adr.getSimm();
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveContiNTLdScSc(uint32_t msz,
                                                       const _ZReg &zt,
                                                       const _PReg &pg,
                                                       const AdrScSc &adr) {
  verifyIncList(adr.getSh(), {msz}, ERR_ILLEGAL_CONST_VALUE);
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code = concat({F(0x52, 25), F(msz, 23), F(adr.getXm().getIdx(), 16),
                          F(6, 13), F(pg.getIdx(), 10),
                          F(adr.getXn().getIdx(), 5), F(zt.getIdx(), 0)});
  dd(code);
}
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveLdBcQuadScImm(uint32_t msz, uint32_t num, const _ZReg &zt,
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveLdBcQuadScSc(uint32_t msz, uint32_t num, const _ZReg &zt,
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveLdMultiStructScImm(uint32_t msz, uint32_t num,
                                     const _ZReg &zt, const _PReg &pg,
                                     const AdrScImm &adr) {
  int32_t imm = adr.getSimm();
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveLdMultiStructScSc(uint32_t msz, uint32_t num, const _ZReg &zt,
                                    const _PReg &pg, const AdrScSc &adr) {
  verifyIncList(adr.getSh(), {msz}, ERR_ILLEGAL_CONST_VALUE);
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code =
      concat({F(0x52, 25), F(msz, 23), F(num, 21), F(adr.getXm().getIdx(), 16),
              F(6, 13), F(pg.getIdx(), 10), F(adr.getXn().getIdx(), 5),
              F(zt.getIdx(), 0)});
  dd(code);
}
...
XBYAK_AARCH64_INLINE void
CodeGenerator::Sve64GatherLdSc32US(uint32_t msz, uint32_t U, uint32_t ff,
                                   const _ZReg &zt, const _PReg &pg,
                                   const AdrSc32US &adr) {
  verifyIncList(adr.getSh(), {msz}, ERR_ILLEGAL_CONST_VALUE);
  uint32_t xs = (adr.getMod() == SXTW) ? 1 : 0;
...
XBYAK_AARCH64_INLINE void
CodeGenerator::Sve64GatherLdSc64S(uint32_t msz, uint32_t U, uint32_t ff,
                                  const _ZReg &zt, const _PReg &pg,
                                  const AdrSc64S &adr) {
  verifyIncList(adr.getSh(), {msz}, ERR_ILLEGAL_CONST_VALUE);
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::Sve64GatherLdSc64U(uint32_t msz, uint32_t U, uint32_t ff,
                                  const _ZReg &zt, const _PReg &pg,
                                  const AdrSc64U &adr) {
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code =
...
XBYAK_AARCH64_INLINE void
CodeGenerator::Sve64GatherLdSc32UU(uint32_t msz, uint32_t U, uint32_t ff,
                                   const _ZReg &zt, const _PReg &pg,
                                   const AdrSc32UU &adr) {
  uint32_t xs = (adr.getMod() == SXTW) ? 1 : 0;
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::Sve64GatherLdVecImm(uint32_t msz, uint32_t U, uint32_t ff,
                                   const _ZReg &zt, const _PReg &pg,
...
// SVE 64-bit gather load (scalar plus 64-bit scaled offsets)
XBYAK_AARCH64_INLINE void CodeGenerator::Sve64GatherPfSc64S(PrfopSve prfop_sve,
                                                         uint32_t msz,
                                                         const _PReg &pg,
                                                         const AdrSc64S &adr) {
  verifyIncList(adr.getSh(), {msz}, ERR_ILLEGAL_CONST_VALUE);
...
// SVE 64-bit gather load (scalar plus unpacked 32-bit scaled offsets)
XBYAK_AARCH64_INLINE void
CodeGenerator::Sve64GatherPfSc32US(PrfopSve prfop_sve, uint32_t msz,
                                   const _PReg &pg, const AdrSc32US &adr) {
  verifyIncList(adr.getSh(), {msz}, ERR_ILLEGAL_CONST_VALUE);
  uint32_t xs = (adr.getMod() == SXTW) ? 1 : 0;
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code =
...
XBYAK_AARCH64_INLINE void
CodeGenerator::Sve64GatherPfVecImm(PrfopSve prfop_sve, uint32_t msz,
                                   const _PReg &pg, const AdrVecImm64 &adr) {
  uint32_t imm = adr.getImm();
  uint32_t imm5 = (imm >> msz) & ones(5);
  ...
  uint32_t code =
      concat({F(0x62, 25), F(msz, 23), F(imm5, 16), F(7, 13),
              F(pg.getIdx(), 10), F(adr.getZn().getIdx(), 5), F(prfop_sve, 0)});
  dd(code);
}

// SVE 32-bit scatter store (sclar plus 32-bit scaled offsets)
XBYAK_AARCH64_INLINE void CodeGenerator::Sve32ScatterStSc32S(uint32_t msz,
                                                          const _ZReg &zt,
                                                          const _PReg &pg,
                                                          const AdrSc32S &adr) {
  verifyIncList(adr.getSh(), {msz}, ERR_ILLEGAL_CONST_VALUE);
...
XBYAK_AARCH64_INLINE void CodeGenerator::Sve32ScatterStSc32U(uint32_t msz,
                                                          const _ZReg &zt,
                                                          const _PReg &pg,
                                                          const AdrSc32U &adr) {
  uint32_t xs = (adr.getMod() == SXTW) ? 1 : 0;
...
XBYAK_AARCH64_INLINE void
CodeGenerator::Sve32ScatterStVecImm(uint32_t msz, const _ZReg &zt,
                                    const _PReg &pg, const AdrVecImm32 &adr) {
  uint32_t imm = adr.getImm();
  uint32_t imm5 = (imm >> msz) & ones(5);
...
XBYAK_AARCH64_INLINE void CodeGenerator::Sve64ScatterStSc64S(uint32_t msz,
                                                          const _ZReg &zt,
                                                          const _PReg &pg,
                                                          const AdrSc64S &adr) {
  verifyIncList(adr.getSh(), {msz}, ERR_ILLEGAL_CONST_VALUE);
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code = concat(
      {F(0x72, 25), F(msz, 23), F(1, 21), F(adr.getZm().getIdx(), 16), F(5, 13),
       F(pg.getIdx(), 10), F(adr.getXn().getIdx(), 5), F(zt.getIdx(), 0)});
  dd(code);
}

// SVE 64-bit scatter store (scalar plus 64-bit unscaled offsets)
XBYAK_AARCH64_INLINE void CodeGenerator::Sve64ScatterStSc64U(uint32_t msz,
                                                          const _ZReg &zt,
                                                          const _PReg &pg,
                                                          const AdrSc64U &adr) {
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code = concat({F(0x72, 25), F(msz, 23), F(adr.getZm().getIdx(), 16),
                          F(5, 13), F(pg.getIdx(), 10),
                          F(adr.getXn().getIdx(), 5), F(zt.getIdx(), 0)});
  dd(code);
}
...
XBYAK_AARCH64_INLINE void
CodeGenerator::Sve64ScatterStSc32US(uint32_t msz, const _ZReg &zt,
                                    const _PReg &pg, const AdrSc32US &adr) {
  verifyIncList(adr.getSh(), {msz}, ERR_ILLEGAL_CONST_VALUE);
  uint32_t xs = (adr.getMod() == SXTW) ? 1 : 0;
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::Sve64ScatterStSc32UU(uint32_t msz, const _ZReg &zt,
                                    const _PReg &pg, const AdrSc32UU &adr) {
  uint32_t xs = (adr.getMod() == SXTW) ? 1 : 0;
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code = concat({F(0x72, 25), F(msz, 23), F(adr.getZm().getIdx(), 16),
                          F(1, 15), F(xs, 14), F(pg.getIdx(), 10),
...
XBYAK_AARCH64_INLINE void
CodeGenerator::Sve64ScatterStVecImm(uint32_t msz, const _ZReg &zt,
                                    const _PReg &pg, const AdrVecImm64 &adr) {
  uint32_t imm = adr.getImm();
  uint32_t imm5 = (imm >> msz) & ones(5);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveContiNTStScImm(uint32_t msz,
                                                        const _ZReg &zt,
                                                        const _PReg &pg,
                                                        const AdrScImm &adr) {
  int32_t imm = adr.getSimm();
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveContiNTStScImm(uint32_t msz,
                                                        ...
                                                        const AdrNoOfs &adr) {
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code = concat({F(0x72, 25), F(msz, 23), F(1, 20), F(0, 16), F(7, 13),
                          F(pg.getIdx(), 10), F(adr.getXn().getIdx(), 5),
                          F(zt.getIdx(), 0)});
  dd(code);
}
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveContiNTStScSc(uint32_t msz,
                                                       const _ZReg &zt,
                                                       const _PReg &pg,
                                                       const AdrScSc &adr) {
  verifyIncList(adr.getSh(), {msz}, ERR_ILLEGAL_CONST_VALUE);
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code = concat({F(0x72, 25), F(msz, 23), F(adr.getXm().getIdx(), 16),
                          F(3, 13), F(pg.getIdx(), 10),
                          F(adr.getXn().getIdx(), 5), F(zt.getIdx(), 0)});
  dd(code);
}

// SVE contiguous store (scalar plus immediate)
XBYAK_AARCH64_INLINE void CodeGenerator::SveContiStScImm(uint32_t msz,
                                                      const _ZReg &zt,
                                                      const _PReg &pg,
                                                      const AdrScImm &adr) {
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveContiStScSc(uint32_t msz,
                                                     const _ZReg &zt,
                                                     const _PReg &pg,
                                                     const AdrScSc &adr) {
  verifyIncList(adr.getSh(), {msz}, ERR_ILLEGAL_CONST_VALUE);
  ...
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code =
      concat({F(0x72, 25), F(msz, 23), F(size, 21), F(adr.getXm().getIdx(), 16),
              F(2, 13), F(pg.getIdx(), 10), F(adr.getXn().getIdx(), 5),
              F(zt.getIdx(), 0)});
  dd(code);
}
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveStMultiStructScImm(uint32_t msz, uint32_t num,
                                     const _ZReg &zt, const _PReg &pg,
                                     const AdrScImm &adr) {
  int32_t imm = adr.getSimm();
  uint32_t imm4 = (imm / ((int32_t)num + 1)) & ones(4);
...
XBYAK_AARCH64_INLINE void
CodeGenerator::SveStMultiStructScSc(uint32_t msz, uint32_t num, const _ZReg &zt,
                                    const _PReg &pg, const AdrScSc &adr) {
  verifyIncList(adr.getSh(), {msz}, ERR_ILLEGAL_CONST_VALUE);
  verifyIncRange(pg.getIdx(), 0, 7, ERR_ILLEGAL_REG_IDX);
  uint32_t code =
      concat({F(0x72, 25), F(msz, 23), F(num, 21), F(adr.getXm().getIdx(), 16),
              F(3, 13), F(pg.getIdx(), 10), F(adr.getXn().getIdx(), 5),
              F(zt.getIdx(), 0)});
  dd(code);
}

// SVE store predicate register
XBYAK_AARCH64_INLINE void CodeGenerator::SveStorePredReg(const _PReg &pt,
                                                      const AdrScImm &adr) {
  int32_t imm = adr.getSimm();
  uint32_t imm9h = field(imm, 8, 3);
  uint32_t imm9l = field(imm, 2, 0);
...
XBYAK_AARCH64_INLINE void CodeGenerator::SveStorePredVec(const _ZReg &zt,
                                                      const AdrScImm &adr) {
  int32_t imm = adr.getSimm();
  uint32_t imm9h = field(imm, 8, 3);
  uint32_t imm9l = field(imm, 2, 0);
